...
import com.panaceasoft.pskotlinmaterial.adapter.feature.list.education.FeatureListEducationList3Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.app_education_list_3_activity.*

class FeatureListEducationVideoList3Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: FeatureListEducationList3Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_education_list_3_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureListEducationList3Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureListEducationList3Adapter.OnItemClickListener {
