...
import kotlinx.android.synthetic.main.app_ecommerce_home_1_item.view.*
import java.util.*
...
class AppECommerceHome1ItemAdapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_home_1_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is AppECommerceHome1ItemAdapter.ItemViewHolder) {
