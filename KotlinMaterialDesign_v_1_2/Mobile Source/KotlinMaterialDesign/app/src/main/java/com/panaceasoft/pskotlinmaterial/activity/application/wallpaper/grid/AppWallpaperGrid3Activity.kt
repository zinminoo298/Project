...
import com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.grid.AppWallpaperGrid3ItemAdapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.app_wallpaper_grid_3_activity.*

class AppWallpaperGrid3Activity : AppCompatActivity() {

    internal lateinit var itemArrayList: List<WallpaperItem>

    internal lateinit var itemAdapter: AppWallpaperGrid3ItemAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.app_wallpaper_grid_3_activity)
    ...
    private fun initUI() {
        ...
        itemAdapter = AppWallpaperGrid3ItemAdapter(itemArrayList)
    ...
    private fun initActions() {
        ...
        itemAdapter.setOnItemClickListener(object : AppWallpaperGrid3ItemAdapter.OnItemClickListener {
