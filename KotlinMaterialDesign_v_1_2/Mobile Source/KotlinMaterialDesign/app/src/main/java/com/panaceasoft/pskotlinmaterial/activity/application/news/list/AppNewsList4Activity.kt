...
import com.panaceasoft.pskotlinmaterial.adapter.application.news.list.AppNewsList4Adapter
...
class AppNewsList4Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var newsArrayList: ArrayList<News>
    internal lateinit var adapter: AppNewsList4Adapter
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppNewsList4Adapter(newsArrayList)
    ...
    private fun initActions() {
        ...
        adapter.setOnItemClickListener(object : AppNewsList4Adapter.OnItemClickListener {
