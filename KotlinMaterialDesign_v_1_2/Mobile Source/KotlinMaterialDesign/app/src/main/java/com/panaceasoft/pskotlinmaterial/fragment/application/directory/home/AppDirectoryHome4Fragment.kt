...
import com.panaceasoft.pskotlinmaterial.adapter.application.directory.home.AppDirectoryHome4Adapter
 ...
 */
class AppDirectoryHome4Fragment : Fragment() {


    // data and adapter
    internal lateinit var userHistoryList: List<UserHistory>
    internal lateinit var adapter: AppDirectoryHome4Adapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.app_directory_home_4_fragment, container, false)
    ...
    private fun initUI(view: View) {
        // get list adapter
        adapter = AppDirectoryHome4Adapter(userHistoryList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppDirectoryHome4Adapter.OnItemClickListener {
