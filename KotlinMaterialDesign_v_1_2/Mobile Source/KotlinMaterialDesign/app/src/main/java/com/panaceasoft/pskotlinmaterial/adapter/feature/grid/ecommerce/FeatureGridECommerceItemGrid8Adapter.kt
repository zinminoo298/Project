...
import kotlinx.android.synthetic.main.feature_grid_ecommerce_item_grid_8_item.view.*
import java.util.*
 ...
 */
class FeatureGridECommerceItemGrid8Adapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_ecommerce_item_grid_8_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is ItemViewHolder) {
            ...
            val viewCount = shopItem.viewCount + " Views"
            viewHolder.viewCountTextView.text = viewCount
