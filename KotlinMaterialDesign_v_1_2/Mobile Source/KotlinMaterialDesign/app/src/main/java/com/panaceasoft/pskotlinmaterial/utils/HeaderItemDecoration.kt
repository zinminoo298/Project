...
class HeaderItemDecoration(recyclerView: RecyclerView, private val mListener: StickyHeaderInterface) : RecyclerView.ItemDecoration() {
...
//        view.layout(0, 0, view.measuredWidth, mStickyHeaderHeight = view.measuredHeight)
    ...
    interface StickyHeaderInterface {
         ...
         * @param itemPosition int. AppECommerceHome5ItemAdapter's position of the item for which to do the search of the position of the header item.
