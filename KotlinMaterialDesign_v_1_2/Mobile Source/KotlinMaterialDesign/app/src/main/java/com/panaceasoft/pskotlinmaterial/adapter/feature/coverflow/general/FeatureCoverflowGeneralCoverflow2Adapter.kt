package com.panaceasoft.pskotlinmaterial.adapter.feature.coverflow.general
 ...
 */
class FeatureCoverflowGeneralCoverflow2Adapter(private val context: Context, private val shopItemList: List<ShopItem>) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater.inflate(R.layout.feature_coverflow_general_coverflow_2_item, container, false)
