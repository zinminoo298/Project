...
import com.panaceasoft.pskotlinmaterial.adapter.application.education.grid.AppEducationGrid2Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.app_education_grid_2_activity.*

class AppEducationGrid2Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: AppEducationGrid2Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_education_grid_2_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppEducationGrid2Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppEducationGrid2Adapter.OnItemClickListener {
