...
class AppECommerceHome5ItemAdapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        var layoutId = R.layout.app_ecommerce_home_5a_item

        if (viewType == 1) {
            layoutId = R.layout.app_ecommerce_home_5b_item
        } else if (viewType == 2) {
            layoutId = R.layout.app_ecommerce_home_5c_item
        }
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is AppECommerceHome5ItemAdapter.ItemViewHolder) {
