...
import com.panaceasoft.pskotlinmaterial.adapter.feature.list.education.FeatureListEducationCourseCollectionList2Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationCourseCollectionRepository
import kotlinx.android.synthetic.main.feature_list_education_course_collection_list_2_activity.*

class FeatureListEducationCourseCollectionList2Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var educationCourseCollectionRepositoryList: List<EducationCourseCollection>
    internal lateinit var adapter: FeatureListEducationCourseCollectionList2Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_list_education_course_collection_list_2_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureListEducationCourseCollectionList2Adapter(educationCourseCollectionRepositoryList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureListEducationCourseCollectionList2Adapter.OnItemClickListener {
