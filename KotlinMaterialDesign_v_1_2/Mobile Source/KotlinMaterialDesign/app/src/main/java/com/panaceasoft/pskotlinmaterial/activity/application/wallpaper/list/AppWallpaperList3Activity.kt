...
import com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.list.AppWallpaperList3ItemAdapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.app_wallpaper_list_3_activity.*

class AppWallpaperList3Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var itemList: List<WallpaperItem>
    internal lateinit var adapter: AppWallpaperList3ItemAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_wallpaper_list_3_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppWallpaperList3ItemAdapter(itemList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppWallpaperList3ItemAdapter.OnItemClickListener {
