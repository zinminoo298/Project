...
import kotlinx.android.synthetic.main.app_news_detail_1_activity.*

class AppNewsDetail1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.app_news_detail_1_activity)
