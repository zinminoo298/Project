package com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.home.home2
...
import kotlinx.android.synthetic.main.app_wallpaper_home_2_category_item.view.*
...
class AppWallpaperHome2CategoryAdapter(private val WallpaperCategoryArrayList: List<WallpaperCategory>?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_wallpaper_home_2_category_item, parent, false)
