...
import com.panaceasoft.pskotlinmaterial.adapter.application.education.grid.AppEducationGrid1Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.app_education_grid_1_activity.*

class AppEducationGrid1Activity : AppCompatActivity() {


    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: AppEducationGrid1Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_education_grid_1_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppEducationGrid1Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppEducationGrid1Adapter.OnItemClickListener {
