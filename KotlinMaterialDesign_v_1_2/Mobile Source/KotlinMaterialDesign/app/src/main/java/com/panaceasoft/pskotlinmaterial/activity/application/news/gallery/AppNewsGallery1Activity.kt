...
import kotlinx.android.synthetic.main.app_news_gallery_1_activity.*

class AppNewsGallery1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.app_news_gallery_1_activity)
