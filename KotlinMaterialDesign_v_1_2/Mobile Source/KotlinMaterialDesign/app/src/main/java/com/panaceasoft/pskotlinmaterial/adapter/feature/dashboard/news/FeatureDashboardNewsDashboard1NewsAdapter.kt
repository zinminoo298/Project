...
import kotlinx.android.synthetic.main.feature_dashboard_news_dashboard_1_item.view.*
 ...
 */
class FeatureDashboardNewsDashboard1NewsAdapter(private val newsList: List<News>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: FeatureDashboardNewsDashboard1NewsAdapter.OnItemClickListener
    ...
    fun setOnItemClickListener(mItemClickListener: FeatureDashboardNewsDashboard1NewsAdapter.OnItemClickListener) {
        this.itemClickListener = mItemClickListener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {

        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_dashboard_news_dashboard_1_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is FeatureDashboardNewsDashboard1NewsAdapter.ItemViewHolder) {
