package com.panaceasoft.pskotlinmaterial.adapter.feature.map
 ...
 */
class FeatureMapDirectoryMap4Adapter(private val placeArrayList: ArrayList<Place>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
