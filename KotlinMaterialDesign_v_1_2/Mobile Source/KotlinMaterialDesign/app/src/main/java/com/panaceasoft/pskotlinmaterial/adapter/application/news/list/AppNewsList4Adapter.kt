 ...
 */
class AppNewsList4Adapter(private val newsArrayList: ArrayList<News>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: AppNewsList4Adapter.OnItemClickListener
    ...
    fun setOnItemClickListener(mItemClickListener: AppNewsList4Adapter.OnItemClickListener) {
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is AppNewsList4Adapter.PlaceViewHolder) {
