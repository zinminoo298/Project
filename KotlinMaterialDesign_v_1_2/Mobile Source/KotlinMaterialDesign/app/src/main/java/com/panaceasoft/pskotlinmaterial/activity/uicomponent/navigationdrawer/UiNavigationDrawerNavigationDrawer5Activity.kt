...
import kotlinx.android.synthetic.main.ui_navigation_drawer_navigation_drawer_5_activity.*

class UiNavigationDrawerNavigationDrawer5Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {

    internal lateinit var toolbar: Toolbar

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_navigation_drawer_navigation_drawer_5_activity)
    ...
    private fun initToolbar() {
        ...
        toolbar.title = "Navigation Drawer 5"
