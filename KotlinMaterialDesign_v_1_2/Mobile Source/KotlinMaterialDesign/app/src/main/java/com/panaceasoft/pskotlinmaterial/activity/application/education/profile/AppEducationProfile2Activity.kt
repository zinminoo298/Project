...
import kotlinx.android.synthetic.main.app_education_profile_2_activity.*

class AppEducationProfile2Activity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_education_profile_2_activity)
