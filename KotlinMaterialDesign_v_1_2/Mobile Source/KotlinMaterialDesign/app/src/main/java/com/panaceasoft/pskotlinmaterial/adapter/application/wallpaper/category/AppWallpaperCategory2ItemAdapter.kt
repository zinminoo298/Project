...
import kotlinx.android.synthetic.main.app_wallpaper_category_2_item.view.*
import java.util.*
 ...
 */
class AppWallpaperCategory2ItemAdapter(private val itemArrayList: ArrayList<WallpaperCategory>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_wallpaper_category_2_item, parent, false)
