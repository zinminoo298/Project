...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.grid.AppECommerceGrid5Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.app_ecommerce_grid_5_activity.*
import java.util.*

class AppECommerceGrid5Activity : AppCompatActivity() {

    private lateinit var itemArrayList: ArrayList<ShopItem>
    private lateinit var mAdapter: AppECommerceGrid5Adapter
    internal var numberOfColumns = 2

    //region override Functions
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_grid_5_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = AppECommerceGrid5Adapter(itemArrayList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : AppECommerceGrid5Adapter.OnItemClickListener {
