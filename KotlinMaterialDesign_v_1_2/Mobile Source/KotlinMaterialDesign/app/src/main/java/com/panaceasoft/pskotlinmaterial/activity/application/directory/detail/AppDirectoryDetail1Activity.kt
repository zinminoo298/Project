...
import kotlinx.android.synthetic.main.app_directory_detail_1_activity.*

class AppDirectoryDetail1Activity : AppCompatActivity() {

    internal lateinit var place: Place

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_directory_detail_1_activity)
