...
class FeatureDashboardRestaurantHome2Adapter(private val itemArrayList: ArrayList<RestaurantFood>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_dashboard_restaurant_home_2_item, parent, false)
