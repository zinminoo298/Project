package com.panaceasoft.pskotlinmaterial.adapter.feature.timeline.education
...
class FeatureTimelineEducationOutline1Adapter(private val itemList: List<EducationCourseOutlineHolder>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        if (viewType == 0) {
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_timeline_education_outline_1_title, parent, false)
            return TitleViewHolder(itemView)
        } else if (viewType == 1) {
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_timeline_education_outline_1_top_item, parent, false)
            return VideoViewHolder(itemView)
        } else if (viewType == 2) {
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_timeline_education_outline_1_bottom_item, parent, false)
            return VideoViewHolder(itemView)
        } else {
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_timeline_education_outline_1_item, parent, false)
            return VideoViewHolder(itemView)
        }
