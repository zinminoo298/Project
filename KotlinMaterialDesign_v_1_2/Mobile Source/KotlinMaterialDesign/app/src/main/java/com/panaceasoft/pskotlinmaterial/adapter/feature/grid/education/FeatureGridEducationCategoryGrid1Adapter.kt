...
import kotlinx.android.synthetic.main.feature_grid_education_category_grid_1_item.view.*
...
class FeatureGridEducationCategoryGrid1Adapter(private val itemList: List<Course>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_education_category_grid_1_item, parent, false)
