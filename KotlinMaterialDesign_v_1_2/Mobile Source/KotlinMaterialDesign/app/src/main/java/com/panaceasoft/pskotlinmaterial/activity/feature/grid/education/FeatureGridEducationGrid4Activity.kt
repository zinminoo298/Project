...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.education.FeatureGridEducationGrid4Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.feature_grid_education_grid_4_activity.*

class FeatureGridEducationGrid4Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: FeatureGridEducationGrid4Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_education_grid_4_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureGridEducationGrid4Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureGridEducationGrid4Adapter.OnItemClickListener {
