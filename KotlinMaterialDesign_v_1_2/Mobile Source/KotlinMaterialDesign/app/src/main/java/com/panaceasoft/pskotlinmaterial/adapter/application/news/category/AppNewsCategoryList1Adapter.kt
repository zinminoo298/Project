...
import kotlinx.android.synthetic.main.app_news_category_list_1_item.view.*
...
class AppNewsCategoryList1Adapter(private val itemArrayList: List<NewsCategory>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_news_category_list_1_item, parent, false)
