...
import kotlinx.android.synthetic.main.feature_detail_directory_place_detail_4_activity.*

class FeatureDetailDirectoryPlaceDetail4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_detail_directory_place_detail_4_activity)
