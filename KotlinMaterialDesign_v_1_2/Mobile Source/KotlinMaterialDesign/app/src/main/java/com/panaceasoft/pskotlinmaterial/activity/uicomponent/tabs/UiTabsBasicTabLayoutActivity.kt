...
import kotlinx.android.synthetic.main.ui_tabs_basic_tab_layout_activity.*

class UiTabsBasicTabLayoutActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_tabs_basic_tab_layout_activity)
    ...
    private fun initToolbar() {
        ...
        toolbar.title = "Basic Tab Layout"
