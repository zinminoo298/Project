...
import kotlinx.android.synthetic.main.app_education_grid_5_item.view.*
 ...
 */
class AppEducationGrid5Adapter(private val itemList: List<EducationVideo>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: AppEducationGrid5Adapter.OnItemClickListener
    ...
    fun setOnItemClickListener(mItemClickListener: AppEducationGrid5Adapter.OnItemClickListener) {
        this.itemClickListener = mItemClickListener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_education_grid_5_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is AppEducationGrid5Adapter.PlaceViewHolder) {
