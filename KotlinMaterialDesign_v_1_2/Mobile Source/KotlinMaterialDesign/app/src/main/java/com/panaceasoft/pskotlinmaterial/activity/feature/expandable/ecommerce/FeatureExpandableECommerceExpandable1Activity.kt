...
import kotlinx.android.synthetic.main.feature_expandable_ecommerce_expandable_1_activity.*

class FeatureExpandableECommerceExpandable1Activity : AppCompatActivity() {
    ...
    private fun initUI() {
        ...
        val color1BgImageView = findViewById<ImageView>(R.id.color1BgImageView)
        val color2BgImageView = findViewById<ImageView>(R.id.color2BgImageView)
        val color3BgImageView = findViewById<ImageView>(R.id.color3BgImageView)
        val color4BgImageView = findViewById<ImageView>(R.id.color4BgImageView)
        val color5BgImageView = findViewById<ImageView>(R.id.color5BgImageView)
        val color6BgImageView = findViewById<ImageView>(R.id.color6BgImageView)
        val color7BgImageView = findViewById<ImageView>(R.id.color7BgImageView)
        ...
        val selectedList = ContextCompat.getDrawable(applicationContext,R.drawable.baseline_selected_list_24)
