...
import kotlinx.android.synthetic.main.feature_detail_wallpaper_photo_detail_1_activity.*

class FeatureDetailWallpaperPhotoDetail1Activity : AppCompatActivity() {

    private var twist = false

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_detail_wallpaper_photo_detail_1_activity)
