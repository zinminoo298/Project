...
import kotlinx.android.synthetic.main.ui_dialogs_dialog_alert_activity.*


class UiDialogsDialogAlertActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_dialogs_dialog_alert_activity)
        ...
        customLayoutPrimaryButton.setOnClickListener { getCustomLayoutDialog(R.layout.ui_widget_dialog_alert_custom_layout, R.color.colorPrimary) }
        customLayoutAccentButton.setOnClickListener { getCustomLayoutDialog(R.layout.ui_widget_dialog_alert_custom_layout, R.color.colorAccent) }
    }
