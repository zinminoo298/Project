...
import kotlinx.android.synthetic.main.app_ecommerce_filter_1_activity.*

class AppECommerceFilter1Activity : AppCompatActivity() {

    private  var selectedList: Drawable? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_filter_1_activity)
