...
import kotlinx.android.synthetic.main.feature_grid_news_grid_5_item.view.*
import java.util.*
 ...
 */
class FeatureGridNewsGrid5Adapter(private val newsArrayList: ArrayList<News>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: FeatureGridNewsGrid5Adapter.OnItemClickListener
    ...
    fun setOnItemClickListener(mItemClickListener: FeatureGridNewsGrid5Adapter.OnItemClickListener) {
        this.itemClickListener = mItemClickListener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_news_grid_5_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is FeatureGridNewsGrid5Adapter.PlaceViewHolder) {
