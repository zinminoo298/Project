...
import com.panaceasoft.pskotlinmaterial.adapter.feature.dashboard.directory.FeatureDashboardDirectoryDashboard2PagerAdapter
 ...
 */
class FeatureDashboardDirectoryDashboard2Fragment : Fragment() {

    private lateinit var pagerAdapter: FeatureDashboardDirectoryDashboard2PagerAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.feature_dashboard_directory_dashboard_2_fragment, container, false)
    ...
    private fun initData() {
        ...
        pagerAdapter = FeatureDashboardDirectoryDashboard2PagerAdapter(context, placeList)
    }
    ...
    private fun initActions() {
        ...
        pagerAdapter.setOnItemClickListener(object : FeatureDashboardDirectoryDashboard2PagerAdapter.OnItemClickListener{
