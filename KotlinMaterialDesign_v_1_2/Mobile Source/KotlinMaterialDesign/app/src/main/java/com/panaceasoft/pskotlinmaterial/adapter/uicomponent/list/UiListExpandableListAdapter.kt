...
import kotlinx.android.synthetic.main.ui_list_expandable_list_item.view.*
...
class UiListExpandableListAdapter(private val generalListList: List<GeneralList>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.ui_list_expandable_list_item, parent, false)
