...
import kotlinx.android.synthetic.main.feature_grid_ecommerce_item_grid_4_item.view.*
import java.util.*
 ...
 */
class FeatureGridECommerceItemGrid4Adapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_ecommerce_item_grid_4_item, parent, false)
