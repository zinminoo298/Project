...
import kotlinx.android.synthetic.main.app_news_home_2_item.view.*
...
class AppNewsHome2NewsAdapter(private val newsList: List<News>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_news_home_2_item, parent, false)
