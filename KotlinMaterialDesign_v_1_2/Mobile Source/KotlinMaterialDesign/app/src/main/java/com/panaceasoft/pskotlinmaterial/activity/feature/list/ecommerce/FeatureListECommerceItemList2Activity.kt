...
import com.panaceasoft.pskotlinmaterial.adapter.feature.list.ecommerce.FeatureListECommerceItemList2Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.feature_list_ecommerce_item_list_2_activity.*

class FeatureListECommerceItemList2Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var shopItemList: List<ShopItem>
    internal lateinit var adapter: FeatureListECommerceItemList2Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_list_ecommerce_item_list_2_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureListECommerceItemList2Adapter(shopItemList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureListECommerceItemList2Adapter.OnItemClickListener {
