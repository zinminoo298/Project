...
import com.panaceasoft.pskotlinmaterial.fragment.application.directory.home.AppDirectoryHome1Fragment
import com.panaceasoft.pskotlinmaterial.utils.Utils
import kotlinx.android.synthetic.main.app_directory_home_1_activity.*

class AppDirectoryHome1Activity : AppCompatActivity() {
    ...
    private fun initUI() {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { item ->
            ...
            when (item.itemId) {
                R.id.searchMenu -> loadFragment(AppDirectoryHome1Fragment())
                //                case R.id.listMenu:
                ...
                //                    break;
                else -> loadFragment(AppDirectoryHome1Fragment())
            }
        ...
        loadFragment(AppDirectoryHome1Fragment())
