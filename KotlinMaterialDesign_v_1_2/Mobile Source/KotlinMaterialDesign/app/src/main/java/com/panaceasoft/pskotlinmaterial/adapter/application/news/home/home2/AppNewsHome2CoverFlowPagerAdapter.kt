...
class AppNewsHome2CoverFlowPagerAdapter(private val context: Context, private val newsList: List<News>) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater.inflate(R.layout.app_news_home_2_cover_flow_pager_item, container, false)
