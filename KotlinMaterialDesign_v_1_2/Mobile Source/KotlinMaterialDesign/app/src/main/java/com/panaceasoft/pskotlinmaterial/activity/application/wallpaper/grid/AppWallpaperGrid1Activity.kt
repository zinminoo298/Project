...
import com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.grid.AppWallpaperGrid1ItemAdapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.app_wallpaper_grid_1_activity.*

class AppWallpaperGrid1Activity : AppCompatActivity() {

    // data and wallpaperHome2CategoryAdapter
    internal lateinit var itemArrayList: List<WallpaperItem>

    internal lateinit var itemAdapter: AppWallpaperGrid1ItemAdapter


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.app_wallpaper_grid_1_activity)
    ...
    private fun initUI() {
        ...
        itemAdapter = AppWallpaperGrid1ItemAdapter(itemArrayList)
    ...
    private fun initActions() {
        ...
        itemAdapter.setOnItemClickListener(object : AppWallpaperGrid1ItemAdapter.OnItemClickListener {
