...
import kotlinx.android.synthetic.main.feature_grid_ecommerce_item_grid_2_item.view.*
import java.util.*
 ...
 */
class FeatureGridECommerceItemGrid2Adapter(private val itemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_ecommerce_item_grid_2_item, parent, false)
