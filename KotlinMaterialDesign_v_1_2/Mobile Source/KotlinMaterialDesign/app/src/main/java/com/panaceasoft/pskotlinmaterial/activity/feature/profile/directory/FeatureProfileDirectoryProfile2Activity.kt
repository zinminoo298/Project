...
import kotlinx.android.synthetic.main.feature_profile_directory_profile_2_activity.*

class FeatureProfileDirectoryProfile2Activity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_profile_directory_profile_2_activity)
