...
import com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.grid.AppWallpaperGrid2ItemAdapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.app_wallpaper_grid_2_activity.*

class AppWallpaperGrid2Activity : AppCompatActivity() {

    internal lateinit var itemArrayList: List<WallpaperItem>

    internal lateinit var itemAdapter: AppWallpaperGrid2ItemAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.app_wallpaper_grid_2_activity)
    ...
    private fun initUI() {
        ...
        itemAdapter = AppWallpaperGrid2ItemAdapter(itemArrayList)
    ...
    private fun initActions() {
        ...
        itemAdapter.setOnItemClickListener(object : AppWallpaperGrid2ItemAdapter.OnItemClickListener {
