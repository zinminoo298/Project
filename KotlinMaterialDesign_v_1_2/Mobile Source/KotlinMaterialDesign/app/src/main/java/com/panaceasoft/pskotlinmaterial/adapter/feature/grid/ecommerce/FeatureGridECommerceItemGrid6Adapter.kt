...
import kotlinx.android.synthetic.main.feature_grid_ecommerce_item_grid_6_item.view.*
import java.util.*
 ...
 */
class FeatureGridECommerceItemGrid6Adapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_ecommerce_item_grid_6_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is ItemViewHolder) {
            ...
            if (shopItem.isLiked != null && shopItem.isLiked == true) {
                val likeImg = Utils.getDrawableInt(context, "baseline_heart")
                Utils.setImageToImageView(context, viewHolder.likeImageView, likeImg)
            } else {
                val notLikeImg = Utils.getDrawableInt(context, "baseline_heart_white")
                Utils.setImageToImageView(context, viewHolder.likeImageView, notLikeImg)
            }

            val ratingCount = "(" + shopItem.ratingCount + ")"
            viewHolder.totalRatingTextView.text = ratingCount
    ...
    inner class ItemViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal var totalRatingTextView: TextView = view.totalRatingTextView
