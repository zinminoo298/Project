...
import com.panaceasoft.pskotlinmaterial.adapter.feature.gallery.directory.FeatureGalleryDirectoryGallery1Adapter
import com.panaceasoft.pskotlinmaterial.repository.directory.PlaceRepository
import kotlinx.android.synthetic.main.feature_gallery_directory_gallery_1_activivty.*
import java.util.*

class FeatureGalleryDirectoryGallery1Activity : AppCompatActivity() {

    private lateinit var placeArrayList: ArrayList<Place>
    private lateinit var mAdapter: FeatureGalleryDirectoryGallery1Adapter
    internal var numberOfColumns = 3

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_gallery_directory_gallery_1_activivty)
    ...
    private fun initUI() {
        ...
        mAdapter = FeatureGalleryDirectoryGallery1Adapter(placeArrayList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : FeatureGalleryDirectoryGallery1Adapter.OnItemClickListener {
