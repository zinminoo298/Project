...
import kotlinx.android.synthetic.main.app_education_list_5_item.view.*
 ...
 */
class AppEducationList5Adapter(private val itemList: List<EducationVideo>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_education_list_5_item, parent, false)
    ...
    inner class PlaceViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal var playImageView: ImageView = view.playImageView2
