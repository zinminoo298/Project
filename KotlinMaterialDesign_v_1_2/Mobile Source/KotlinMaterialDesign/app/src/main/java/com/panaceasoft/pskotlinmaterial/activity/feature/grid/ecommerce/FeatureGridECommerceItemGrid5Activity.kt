...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.ecommerce.FeatureGridECommerceItemGrid5Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.feature_grid_ecommerce_item_grid_5_activity.*
import java.util.*

class FeatureGridECommerceItemGrid5Activity : AppCompatActivity() {

    private lateinit var itemArrayList: ArrayList<ShopItem>
    private lateinit var mAdapter: FeatureGridECommerceItemGrid5Adapter
    internal var numberOfColumns = 2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_ecommerce_item_grid_5_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = FeatureGridECommerceItemGrid5Adapter(itemArrayList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : FeatureGridECommerceItemGrid5Adapter.OnItemClickListener {
