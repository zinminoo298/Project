...
import com.panaceasoft.pskotlinmaterial.adapter.feature.dashboard.restaurant.FeatureDashboardRestaurantHome4Adapter
...
class FeatureDashboardRestaurantHome4Activity : AppCompatActivity() {

    lateinit var itemArrayList: ArrayList<RestaurantFood>
    lateinit var mAdapter: FeatureDashboardRestaurantHome4Adapter
    lateinit var recyclerView: RecyclerView


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_dashboard_restaurant_home_4_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = FeatureDashboardRestaurantHome4Adapter(itemArrayList)
