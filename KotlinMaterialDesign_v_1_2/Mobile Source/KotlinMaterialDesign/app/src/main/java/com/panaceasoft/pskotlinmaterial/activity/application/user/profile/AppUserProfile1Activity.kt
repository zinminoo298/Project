...
import kotlinx.android.synthetic.main.app_user_profile_1_activity.*

class AppUserProfile1Activity : AppCompatActivity() {

    //region override functions
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_user_profile_1_activity)
