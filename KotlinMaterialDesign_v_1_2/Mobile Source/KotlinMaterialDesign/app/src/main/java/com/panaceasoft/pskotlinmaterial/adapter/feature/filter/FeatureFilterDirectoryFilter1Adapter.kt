package com.panaceasoft.pskotlinmaterial.adapter.feature.filter
...
import kotlinx.android.synthetic.main.feature_filter_directory_filter_1_item.view.*
import java.util.*
...
class FeatureFilterDirectoryFilter1Adapter(private val placeArrayList: ArrayList<Place>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_filter_directory_filter_1_item, parent, false)
