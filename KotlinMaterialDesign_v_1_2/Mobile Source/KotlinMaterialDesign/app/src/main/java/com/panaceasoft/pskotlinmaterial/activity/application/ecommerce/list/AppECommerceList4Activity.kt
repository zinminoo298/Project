...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.list.AppECommerceList4Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.app_ecommerce_list_4_activity.*

class AppECommerceList4Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var shopItemList: List<ShopItem>
    internal lateinit var adapter: AppECommerceList4Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_list_4_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppECommerceList4Adapter(shopItemList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppECommerceList4Adapter.OnItemClickListener {
