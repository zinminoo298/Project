...
import kotlinx.android.synthetic.main.feature_rating_general_list_2_item.view.*
 ...
 */
class FeatureRatingGeneralList2Adapter(private val ratingItemList: List<RatingItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_rating_general_list_2_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is PlaceViewHolder) {
            ...
            viewHolder.regionTextView.text = ratingItem.title
