...
import kotlinx.android.synthetic.main.app_directory_home_7_item.view.*
import java.util.*
 ...
 */
class AppDirectoryHome7ItemAdapter(private val catArrayList: ArrayList<DirectoryHome7Category>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_directory_home_7_item, parent, false)
