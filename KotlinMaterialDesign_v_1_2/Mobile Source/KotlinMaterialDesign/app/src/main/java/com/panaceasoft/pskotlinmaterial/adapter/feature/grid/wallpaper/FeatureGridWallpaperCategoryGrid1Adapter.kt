...
import kotlinx.android.synthetic.main.feature_grid_wallpaper_category_grid_1_item.view.*
import java.util.*
 ...
 */
class FeatureGridWallpaperCategoryGrid1Adapter(private val itemArrayList: ArrayList<WallpaperCategory>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_wallpaper_category_grid_1_item, parent, false)
