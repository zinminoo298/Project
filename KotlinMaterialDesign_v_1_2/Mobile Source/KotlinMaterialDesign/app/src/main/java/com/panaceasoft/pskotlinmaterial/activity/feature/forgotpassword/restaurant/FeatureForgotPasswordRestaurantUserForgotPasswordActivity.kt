package com.panaceasoft.pskotlinmaterial.activity.feature.forgotpassword.restaurant
...
class FeatureForgotPasswordRestaurantUserForgotPasswordActivity : AppCompatActivity() {

    //region Override Functions
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_forgot_password_restaurant_user_forgot_password_activity)
