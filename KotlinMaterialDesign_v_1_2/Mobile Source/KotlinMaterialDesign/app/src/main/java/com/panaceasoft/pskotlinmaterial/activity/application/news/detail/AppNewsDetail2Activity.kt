...
import kotlinx.android.synthetic.main.app_news_detail_2_activity.*

class AppNewsDetail2Activity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_news_detail_2_activity)
