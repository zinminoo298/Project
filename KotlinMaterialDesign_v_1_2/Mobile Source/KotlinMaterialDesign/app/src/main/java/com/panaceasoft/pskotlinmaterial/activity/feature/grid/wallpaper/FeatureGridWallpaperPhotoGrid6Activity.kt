...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.wallpaper.FeatureGridWallpaperPhotoGrid6Adapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.feature_grid_wallpaper_photo_grid_6_activity.*

class FeatureGridWallpaperPhotoGrid6Activity : AppCompatActivity() {

    internal lateinit var itemArrayList: List<WallpaperItem>

    internal lateinit var itemAdapter: FeatureGridWallpaperPhotoGrid6Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_wallpaper_photo_grid_6_activity)
    ...
    private fun initUI() {
        ...
        itemAdapter = FeatureGridWallpaperPhotoGrid6Adapter(itemArrayList)
    ...
    private fun initActions() {
        ...
        itemAdapter.setOnItemClickListener(object : FeatureGridWallpaperPhotoGrid6Adapter.OnItemClickListener {
