...
import com.panaceasoft.pskotlinmaterial.adapter.application.news.grid.AppNewsGrid5Adapter
import com.panaceasoft.pskotlinmaterial.repository.news.NewsRepository
import kotlinx.android.synthetic.main.app_news_grid_5_activity.*
import java.util.*

class AppNewsGrid5Activity : AppCompatActivity() {

    private lateinit var itemArrayList: ArrayList<News>
    private lateinit var mAdapter: AppNewsGrid5Adapter
    internal var numberOfColumns = 2

    //region override methods
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_news_grid_5_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = AppNewsGrid5Adapter(itemArrayList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : AppNewsGrid5Adapter.OnItemClickListener {
