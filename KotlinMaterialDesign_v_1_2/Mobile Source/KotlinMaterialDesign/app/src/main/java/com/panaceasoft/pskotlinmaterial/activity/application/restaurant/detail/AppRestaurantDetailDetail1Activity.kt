package com.panaceasoft.pskotlinmaterial.activity.application.restaurant.detail
...
class AppRestaurantDetailDetail1Activity : AppCompatActivity() {

    internal var price: Int = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_restaurant_detail_detail_1_activity)
    ...
    private fun initActions() {
        ...
        addToCardButton.setOnClickListener {Toast.makeText(this@AppRestaurantDetailDetail1Activity, "Clicked Add To Card Button", Toast.LENGTH_SHORT).show() }
        payButton.setOnClickListener { Toast.makeText(this@AppRestaurantDetailDetail1Activity, "Clicked Pay Button", Toast.LENGTH_SHORT).show() }
