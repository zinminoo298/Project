...
import kotlinx.android.synthetic.main.app_ecommerce_basket_4_item.view.*
import java.util.*
...
class AppECommerceBasket4Adapter(private val basketList: List<Basket>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_basket_4_item, parent, false)
