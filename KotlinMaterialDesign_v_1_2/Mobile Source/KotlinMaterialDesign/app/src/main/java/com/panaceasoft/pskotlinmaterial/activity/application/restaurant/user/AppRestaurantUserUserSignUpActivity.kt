...
class AppRestaurantUserUserSignUpActivity : AppCompatActivity() {

    //region override functions
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_restaurant_user_user_sign_up_activity)
    ...
    private fun initActions() {
        ...
        showOrHidePasswordIcon.setOnTouchListener { _, event ->
