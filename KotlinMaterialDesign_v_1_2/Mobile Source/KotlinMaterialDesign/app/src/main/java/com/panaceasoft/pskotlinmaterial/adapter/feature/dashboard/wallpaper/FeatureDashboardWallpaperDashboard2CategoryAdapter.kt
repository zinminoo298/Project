...
import kotlinx.android.synthetic.main.feature_dashboard_wallpaper_dashboard_2_category_item.view.*
 ...
 */
class FeatureDashboardWallpaperDashboard2CategoryAdapter(private val WallpaperCategoryArrayList: List<WallpaperCategory>?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_dashboard_wallpaper_dashboard_2_category_item, parent, false)
