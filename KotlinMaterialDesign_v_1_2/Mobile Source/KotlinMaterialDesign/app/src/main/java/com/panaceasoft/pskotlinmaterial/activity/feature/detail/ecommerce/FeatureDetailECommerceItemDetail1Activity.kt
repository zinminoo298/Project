...
import com.panaceasoft.pskotlinmaterial.adapter.feature.detail.ecommerce.FeatureDetailECommerceItemDetail1PagerAdapter
import com.panaceasoft.pskotlinmaterial.adapter.feature.detail.ecommerce.FeatureDetailECommerceItemDetail1ReviewAdapter
...
import kotlinx.android.synthetic.main.feature_detail_ecommerce_item_detail_1_activity.*

class FeatureDetailECommerceItemDetail1Activity : AppCompatActivity() {
    ...
    // ui variables
    private lateinit var FeatureDetailECommerceItemDetail1PagerAdapter: FeatureDetailECommerceItemDetail1PagerAdapter
    private lateinit var adapter: FeatureDetailECommerceItemDetail1ReviewAdapter
    ...
    private fun initData() {
        ...
        FeatureDetailECommerceItemDetail1PagerAdapter = FeatureDetailECommerceItemDetail1PagerAdapter(this, shopItem)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureDetailECommerceItemDetail1ReviewAdapter(userReviewList)
    ...
    private fun initDataBindings() {
        ...
        imageViewPager.adapter = FeatureDetailECommerceItemDetail1PagerAdapter
    ...
    private fun initActions() {
        imageViewPager.addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(position: Int) {
                ...
                for (i in 0 until dotsCount) {
                    dots[i]?.setImageDrawable(ContextCompat.getDrawable(this@FeatureDetailECommerceItemDetail1Activity,R.drawable.nonselecteditem_dot))
                }

                dots[position]?.setImageDrawable(ContextCompat.getDrawable(this@FeatureDetailECommerceItemDetail1Activity,R.drawable.selecteditem_dot))
            }
        ...
        adapter.setOnItemClickListener(object : FeatureDetailECommerceItemDetail1ReviewAdapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: UserReview, position: Int) {
                Toast.makeText(this@FeatureDetailECommerceItemDetail1Activity, "Selected : " + obj.userName, Toast.LENGTH_LONG).show()
            }
        })


        FeatureDetailECommerceItemDetail1PagerAdapter.setOnItemClickListener(object : FeatureDetailECommerceItemDetail1PagerAdapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: ShopItem, position: Int) {
                Toast.makeText(this@FeatureDetailECommerceItemDetail1Activity, "Selected : " + obj.imageList.get(position).imageName!!, Toast.LENGTH_SHORT).show()
            }
        })
    ...
    fun setupSliderPagination() {
        ...
        dotsCount = FeatureDetailECommerceItemDetail1PagerAdapter.count
