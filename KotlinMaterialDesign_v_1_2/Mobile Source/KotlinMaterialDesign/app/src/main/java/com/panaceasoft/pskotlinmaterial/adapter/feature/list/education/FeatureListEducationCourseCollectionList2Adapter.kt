...
import kotlinx.android.synthetic.main.feature_list_education_course_collection_list_2_item.view.*
...
class FeatureListEducationCourseCollectionList2Adapter(private val itemList: List<EducationCourseCollection>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_list_education_course_collection_list_2_item, parent, false)
