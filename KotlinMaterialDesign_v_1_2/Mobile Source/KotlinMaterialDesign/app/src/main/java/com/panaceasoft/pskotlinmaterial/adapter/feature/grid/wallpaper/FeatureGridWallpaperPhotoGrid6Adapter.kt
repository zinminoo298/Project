...
import kotlinx.android.synthetic.main.feature_grid_wallpaper_photo_grid_6_item.view.*
 ...
 */
class FeatureGridWallpaperPhotoGrid6Adapter(private val wallpaperItemArrayList: List<WallpaperItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_wallpaper_photo_grid_6_item, parent, false)
