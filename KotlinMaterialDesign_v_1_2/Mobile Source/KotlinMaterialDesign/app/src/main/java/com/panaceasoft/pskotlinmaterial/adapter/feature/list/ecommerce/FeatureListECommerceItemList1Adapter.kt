...
import kotlinx.android.synthetic.main.feature_list_ecommerce_item_list_1_item.view.*
 ...
 */
class FeatureListECommerceItemList1Adapter(private val shopItemList: List<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_list_ecommerce_item_list_1_item, parent, false)
