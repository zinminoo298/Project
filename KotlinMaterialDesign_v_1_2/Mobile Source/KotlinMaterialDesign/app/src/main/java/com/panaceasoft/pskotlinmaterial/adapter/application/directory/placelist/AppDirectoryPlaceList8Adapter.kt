...
import kotlinx.android.synthetic.main.app_directory_place_list_8_item.view.*
import java.util.*

class AppDirectoryPlaceList8Adapter(private val placeArrayList: ArrayList<Place>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_directory_place_list_8_item, parent, false)
