...
import com.panaceasoft.pskotlinmaterial.adapter.application.education.list.AppEducationList5Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.app_education_list_5_activity.*

class AppEducationList5Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: AppEducationList5Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_education_list_5_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppEducationList5Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppEducationList5Adapter.OnItemClickListener {
