...
import kotlinx.android.synthetic.main.feature_gallery_directory_gallery_1_item.view.*
import java.util.*
...
class FeatureGalleryDirectoryGallery1Adapter(private val placeArrayList: ArrayList<Place>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_gallery_directory_gallery_1_item, parent, false)
