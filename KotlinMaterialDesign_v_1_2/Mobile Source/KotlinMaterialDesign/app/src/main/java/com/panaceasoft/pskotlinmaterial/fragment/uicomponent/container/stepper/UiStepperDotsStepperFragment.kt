...
class UiStepperDotsStepperFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.ui_stepper_dots_stepper_fragment, container, false)
    ...
    companion object {
        ...
        fun newInstance(position: Int): UiStepperDotsStepperFragment {
            val fragment = UiStepperDotsStepperFragment()
