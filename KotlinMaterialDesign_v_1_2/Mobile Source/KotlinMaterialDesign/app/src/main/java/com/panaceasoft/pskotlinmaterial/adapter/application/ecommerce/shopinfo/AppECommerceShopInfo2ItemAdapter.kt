package com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.shopinfo
...
import kotlinx.android.synthetic.main.app_ecommerce_shop_info_2_item.view.*
import java.util.*
...
class AppECommerceShopInfo2ItemAdapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_shop_info_2_item, parent, false)
