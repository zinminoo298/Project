...
import kotlinx.android.synthetic.main.feature_grid_ecommerce_item_grid_3_item.view.*
import java.util.*
 ...
 */
class FeatureGridECommerceItemGrid3Adapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_ecommerce_item_grid_3_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is ItemViewHolder) {
            ...
            if (shopItem.isLiked != null && shopItem.isLiked == true) {
                ...
                val notLikeImg = Utils.getDrawableInt(context, "baseline_heart_grey")
