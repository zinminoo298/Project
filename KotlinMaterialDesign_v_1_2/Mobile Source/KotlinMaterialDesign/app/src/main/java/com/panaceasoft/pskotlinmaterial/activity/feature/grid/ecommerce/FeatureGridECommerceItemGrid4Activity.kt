...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.ecommerce.FeatureGridECommerceItemGrid4Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.feature_grid_ecommerce_item_grid_4_activity.*
import java.util.*

class FeatureGridECommerceItemGrid4Activity : AppCompatActivity() {

    private lateinit var itemArrayList: ArrayList<ShopItem>
    private lateinit var mAdapter: FeatureGridECommerceItemGrid4Adapter
    internal var numberOfColumns = 2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_ecommerce_item_grid_4_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = FeatureGridECommerceItemGrid4Adapter(itemArrayList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : FeatureGridECommerceItemGrid4Adapter.OnItemClickListener {
