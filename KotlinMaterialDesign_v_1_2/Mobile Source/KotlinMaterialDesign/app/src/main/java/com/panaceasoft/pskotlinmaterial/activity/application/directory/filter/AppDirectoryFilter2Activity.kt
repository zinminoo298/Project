...
import kotlinx.android.synthetic.main.app_directory_filter_2_activity.*
import java.util.*

class AppDirectoryFilter2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.app_directory_filter_2_activity)
