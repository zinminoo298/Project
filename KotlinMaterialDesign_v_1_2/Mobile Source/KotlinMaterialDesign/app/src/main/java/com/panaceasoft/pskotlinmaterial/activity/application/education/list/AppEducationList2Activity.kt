...
import com.panaceasoft.pskotlinmaterial.adapter.application.education.list.AppEducationList2Adapter
...
class AppEducationList2Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: AppEducationList2Adapter
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppEducationList2Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppEducationList2Adapter.OnItemClickListener {
