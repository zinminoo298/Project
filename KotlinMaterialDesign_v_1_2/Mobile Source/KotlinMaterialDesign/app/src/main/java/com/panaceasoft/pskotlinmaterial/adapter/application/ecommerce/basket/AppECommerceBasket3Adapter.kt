...
import kotlinx.android.synthetic.main.app_ecommerce_basket_3_item.view.*
...
class AppECommerceBasket3Adapter(private val basketList: List<Basket>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_basket_3_item, parent, false)
    ...
    inner class PlaceViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal var qtyTextView: TextView = view.qtyTextView
