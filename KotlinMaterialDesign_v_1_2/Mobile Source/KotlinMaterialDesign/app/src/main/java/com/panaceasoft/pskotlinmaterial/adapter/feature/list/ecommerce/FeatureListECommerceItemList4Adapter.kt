...
import kotlinx.android.synthetic.main.feature_list_ecommerce_item_list_4_item.view.*
 ...
 */
class FeatureListECommerceItemList4Adapter(private val shopItemList: List<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    interface OnItemClickListener {
        ...
        fun onLikedClick(view: View, obj: ShopItem, position: Int)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_list_ecommerce_item_list_4_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is PlaceViewHolder) {
            ...
            if (Integer.parseInt(shopItem.discount) > 0) {
                ...
                viewHolder.likeImageView.setOnClickListener { v: View -> itemClickListener.onLikedClick(v, shopItemList[position], position) }
