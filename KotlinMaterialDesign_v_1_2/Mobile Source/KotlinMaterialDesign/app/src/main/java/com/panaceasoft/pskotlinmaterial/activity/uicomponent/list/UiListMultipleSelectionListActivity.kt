...
import com.panaceasoft.pskotlinmaterial.adapter.uicomponent.list.UiListMultipleSelectionListAdapter
import com.panaceasoft.pskotlinmaterial.repository.general.GeneralChatListRepository
import com.panaceasoft.pskotlinmaterial.utils.AlertDialogHelper
import com.panaceasoft.pskotlinmaterial.utils.RecyclerItemClickListener
import java.util.*

class UiListMultipleSelectionListActivity : AppCompatActivity(), AlertDialogHelper.AlertDialogListener {

    private var mActionMode: ActionMode? = null
    private lateinit var toolbar: Toolbar
    private lateinit var multiSelectAdapter: UiListMultipleSelectionListAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.ui_list_multiple_selection_list_activity)
        ...
        initToolbar()
        multiSelectAdapter = UiListMultipleSelectionListAdapter(this, user_list, multiSelectList)
