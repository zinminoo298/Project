...
import kotlinx.android.synthetic.main.ui_seekbar_seekbar_basic_activity.*

class UiSeekBarSeekBarBasicActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_seekbar_seekbar_basic_activity)
    ...
    private fun initUI() {
        val defaultStr = "Selected Value : " + " " + "50"
        ...
        val defaultStr2 = "Selected Value : " + " " + "50"
        ...
        val defaultStr3 = "Selected Value : " + " " + "50"
