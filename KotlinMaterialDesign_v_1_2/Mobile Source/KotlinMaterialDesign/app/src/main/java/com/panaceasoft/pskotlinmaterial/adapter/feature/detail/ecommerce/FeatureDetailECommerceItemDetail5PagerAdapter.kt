 ...
 */
class FeatureDetailECommerceItemDetail5PagerAdapter(private val context: Context, private val shopItem: ShopItem) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater.inflate(R.layout.feature_detail_ecommerce_item_detail_5_pager_item, container, false)
