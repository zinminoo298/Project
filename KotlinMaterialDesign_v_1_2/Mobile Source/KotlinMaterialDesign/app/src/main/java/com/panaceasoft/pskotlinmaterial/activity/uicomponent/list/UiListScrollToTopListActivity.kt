...
import com.panaceasoft.pskotlinmaterial.adapter.uicomponent.list.UiListScrollToTopListAdapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.ui_list_scroll_to_top_list_activity.*

class UiListScrollToTopListActivity : AppCompatActivity() {

    // data and adapter
    internal lateinit var itemList: List<WallpaperItem>
    internal lateinit var adapter: UiListScrollToTopListAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_list_scroll_to_top_list_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = UiListScrollToTopListAdapter(itemList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : UiListScrollToTopListAdapter.OnItemClickListener{
