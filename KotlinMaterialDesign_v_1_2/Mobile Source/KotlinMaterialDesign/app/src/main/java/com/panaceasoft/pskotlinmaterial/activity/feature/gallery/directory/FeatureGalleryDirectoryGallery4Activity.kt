...
import com.panaceasoft.pskotlinmaterial.adapter.feature.gallery.directory.FeatureGalleryDirectoryGallery4Adapter
import com.panaceasoft.pskotlinmaterial.repository.directory.SectionGalleryRepository
import kotlinx.android.synthetic.main.feature_gallery_directory_gallery_4_activity.*
import java.util.*

class FeatureGalleryDirectoryGallery4Activity : AppCompatActivity() {

    private lateinit var mAdapter: FeatureGalleryDirectoryGallery4Adapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_gallery_directory_gallery_4_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = FeatureGalleryDirectoryGallery4Adapter(holderList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : FeatureGalleryDirectoryGallery4Adapter.OnItemClickListener {
