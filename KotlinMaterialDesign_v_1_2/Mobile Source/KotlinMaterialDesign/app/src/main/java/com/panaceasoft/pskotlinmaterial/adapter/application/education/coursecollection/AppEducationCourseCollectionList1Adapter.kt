...
import kotlinx.android.synthetic.main.app_education_course_collection_1_item.view.*
...
class AppEducationCourseCollectionList1Adapter(private val itemList: List<EducationCourseCollection>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_education_course_collection_1_item, parent, false)
