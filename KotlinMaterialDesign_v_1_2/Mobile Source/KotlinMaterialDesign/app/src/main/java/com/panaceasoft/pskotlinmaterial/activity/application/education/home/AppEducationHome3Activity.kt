...
import com.panaceasoft.pskotlinmaterial.fragment.application.education.home.home3.AppEducationHome3Fragment1
import com.panaceasoft.pskotlinmaterial.fragment.application.education.home.home3.AppEducationHome3Fragment2
import com.panaceasoft.pskotlinmaterial.utils.common_adapter.ViewPagerAdapter
import kotlinx.android.synthetic.main.app_education_home_3_activity.*

class AppEducationHome3Activity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_education_home_3_activity)
        ...
        try {
            ...
            tabLayout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
                ...
                override fun onTabUnselected(tab: TabLayout.Tab) {
                    if (tab.icon != null) {
                        tab.icon?.setColorFilter(ContextCompat.getColor(this@AppEducationHome3Activity,R.color.md_grey_200), PorterDuff.Mode.SRC_IN)
                    }
                }
    ...
    private fun setupViewPager(viewPager: ViewPager) {
        ...
        val fragment1 = AppEducationHome3Fragment1()

        val fragment2 = AppEducationHome3Fragment2()
