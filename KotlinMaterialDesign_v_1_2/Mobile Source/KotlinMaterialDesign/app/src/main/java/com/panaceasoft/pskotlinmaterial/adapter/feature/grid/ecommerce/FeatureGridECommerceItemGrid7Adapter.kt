...
import kotlinx.android.synthetic.main.feature_grid_ecommerce_item_grid_7_item.view.*
import java.util.*
 ...
 */
class FeatureGridECommerceItemGrid7Adapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_ecommerce_item_grid_7_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is ItemViewHolder) {
            ...
            val viewCnt = shopItem.viewCount + " Views"
            viewHolder.countTextView.text = viewCnt
    ...
    inner class ItemViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal var countTextView: TextView = view.countTextView
