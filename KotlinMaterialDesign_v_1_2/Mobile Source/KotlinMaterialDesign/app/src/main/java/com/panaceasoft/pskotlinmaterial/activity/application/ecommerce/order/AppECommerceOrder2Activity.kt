...
import kotlinx.android.synthetic.main.app_ecommerce_order_2_activity.*

class AppECommerceOrder2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.app_ecommerce_order_2_activity)
