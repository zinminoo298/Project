...
import com.panaceasoft.pskotlinmaterial.adapter.feature.list.education.FeatureListEducationList5Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.feature_list_education_video_list_5_activity.*

class FeatureListEducationVideoList5Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: FeatureListEducationList5Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_list_education_video_list_5_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureListEducationList5Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureListEducationList5Adapter.OnItemClickListener {
