...
class AppRestaurantHomeHome5Activity : AppCompatActivity() {


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_restaurant_home_5_activity)
    ...
    private fun initAction() {
        letEatButton!!.setOnClickListener {Toast.makeText(this@AppRestaurantHomeHome5Activity, "Clicked Search Button", Toast.LENGTH_SHORT).show() }
    }
