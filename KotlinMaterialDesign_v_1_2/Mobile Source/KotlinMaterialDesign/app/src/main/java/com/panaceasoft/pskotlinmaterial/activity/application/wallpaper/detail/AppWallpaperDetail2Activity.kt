...
import kotlinx.android.synthetic.main.app_wallpaper_detail_2_activity.*

class AppWallpaperDetail2Activity : AppCompatActivity() {

    //region override methods
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_wallpaper_detail_2_activity)
