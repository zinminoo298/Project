...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.list.AppECommerceList6Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.app_ecommerce_list_6_activity.*

class AppECommerceList6Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var shopItemList: List<ShopItem>
    internal lateinit var adapter: AppECommerceList6Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_list_6_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppECommerceList6Adapter(shopItemList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppECommerceList6Adapter.OnItemClickListener {
