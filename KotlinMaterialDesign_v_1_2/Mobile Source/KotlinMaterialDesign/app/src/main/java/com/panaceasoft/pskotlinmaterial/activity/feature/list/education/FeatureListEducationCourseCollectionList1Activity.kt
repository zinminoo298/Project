...
import com.panaceasoft.pskotlinmaterial.adapter.feature.list.education.FeatureListEducationCourseCollectionList1Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationCourseCollectionRepository
import com.panaceasoft.pskotlinmaterial.utils.Utils
import kotlinx.android.synthetic.main.feature_list_education_course_collection_list_1_activity.*

class FeatureListEducationCourseCollectionList1Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var educationCourseCollectionRepositoryList: List<EducationCourseCollection>
    internal lateinit  var adapter: FeatureListEducationCourseCollectionList1Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_list_education_course_collection_list_1_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureListEducationCourseCollectionList1Adapter(educationCourseCollectionRepositoryList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureListEducationCourseCollectionList1Adapter.OnItemClickListener{
