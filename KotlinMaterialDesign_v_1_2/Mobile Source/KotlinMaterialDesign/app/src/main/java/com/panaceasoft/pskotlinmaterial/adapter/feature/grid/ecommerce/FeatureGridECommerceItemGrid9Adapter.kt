...
import kotlinx.android.synthetic.main.feature_grid_ecommerce_item_grid_9_item.view.*
import java.util.*
 ...
 */
class FeatureGridECommerceItemGrid9Adapter(private val itemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_ecommerce_item_grid_9_item, parent, false)
