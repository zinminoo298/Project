...
import com.panaceasoft.pskotlinmaterial.adapter.application.education.list.AppEducationList3Adapter
...
class AppEducationList3Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: AppEducationList3Adapter
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppEducationList3Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppEducationList3Adapter.OnItemClickListener {
