...
import kotlinx.android.synthetic.main.feature_grid_education_grid_2_item.view.*
...
class FeatureGridEducationGrid2Adapter(private val itemList: List<EducationVideo>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_education_grid_2_item, parent, false)
