...
class AppRestaurantList1Adapter(private val RestaurantFoodList: List<RestaurantFood>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_restaurant_list_1_item, parent, false)
