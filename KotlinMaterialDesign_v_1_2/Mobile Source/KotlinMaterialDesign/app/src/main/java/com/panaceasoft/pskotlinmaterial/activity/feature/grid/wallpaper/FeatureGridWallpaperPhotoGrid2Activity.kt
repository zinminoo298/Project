...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.wallpaper.FeatureGridWallpaperPhotoGrid2Adapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.feature_grid_wallpaper_photo_grid_2_activity.*

class FeatureGridWallpaperPhotoGrid2Activity : AppCompatActivity() {

    internal lateinit var itemArrayList: List<WallpaperItem>

    internal lateinit var itemAdapter: FeatureGridWallpaperPhotoGrid2Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_wallpaper_photo_grid_2_activity)
    ...
    private fun initUI() {
        ...
        itemAdapter = FeatureGridWallpaperPhotoGrid2Adapter(itemArrayList)
    ...
    private fun initActions() {
        ...
        itemAdapter.setOnItemClickListener(object : FeatureGridWallpaperPhotoGrid2Adapter.OnItemClickListener {
