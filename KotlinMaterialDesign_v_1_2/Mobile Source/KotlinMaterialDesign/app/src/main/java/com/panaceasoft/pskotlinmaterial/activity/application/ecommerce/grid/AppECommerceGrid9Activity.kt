...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.grid.AppECommerceGrid9Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.app_ecommerce_grid_9_activity.*
import java.util.*

class AppECommerceGrid9Activity : AppCompatActivity() {

    private lateinit var itemArrayList: ArrayList<ShopItem>
    private lateinit var mAdapter: AppECommerceGrid9Adapter

    //region override methods
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_grid_9_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = AppECommerceGrid9Adapter(itemArrayList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : AppECommerceGrid9Adapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: ShopItem, position: Int) {
                Toast.makeText(this@AppECommerceGrid9Activity, "Selected : " + obj.name, Toast.LENGTH_LONG).show()
            }
        })
    }
