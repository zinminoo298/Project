...
import kotlinx.android.synthetic.main.ui_fab_horizontal_submenu_fab_activity.*

class UiFabHorizontalSubMenuFabActivity : AppCompatActivity() {

    private var twist = false

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_fab_horizontal_submenu_fab_activity)
    ...
    private fun initToolbar() {
        ...
        toolbar.title = "Horizontal SubMenu FAB"
