...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.news.FeatureGridNewsGrid2Adapter
import com.panaceasoft.pskotlinmaterial.repository.news.NewsRepository
import kotlinx.android.synthetic.main.feature_grid_news_grid_2_activity.*
import java.util.*

class FeatureGridNewsGrid2Activity : AppCompatActivity() {

    private lateinit var itemArrayList: ArrayList<News>
    private lateinit var mAdapter: FeatureGridNewsGrid2Adapter
    internal var numberOfColumns = 2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_news_grid_2_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = FeatureGridNewsGrid2Adapter(itemArrayList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : FeatureGridNewsGrid2Adapter.OnItemClickListener {
