...
import com.panaceasoft.pskotlinmaterial.adapter.feature.list.ecommerce.FeatureListECommerceItemList6Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.feature_list_ecommerce_item_list_6_activity.*

class FeatureListECommerceItemList6Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var shopItemList: List<ShopItem>
    internal lateinit var adapter: FeatureListECommerceItemList6Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_list_ecommerce_item_list_6_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureListECommerceItemList6Adapter(shopItemList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureListECommerceItemList6Adapter.OnItemClickListener {
