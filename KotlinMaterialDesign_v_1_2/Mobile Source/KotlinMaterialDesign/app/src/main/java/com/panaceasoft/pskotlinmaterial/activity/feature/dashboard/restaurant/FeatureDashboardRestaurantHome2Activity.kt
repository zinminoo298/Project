...
import com.panaceasoft.pskotlinmaterial.adapter.feature.dashboard.restaurant.FeatureDashboardRestaurantHome2Adapter
...
class FeatureDashboardRestaurantHome2Activity : AppCompatActivity() {

    lateinit var itemArrayList: ArrayList<RestaurantFood>
    lateinit var mAdapter: FeatureDashboardRestaurantHome2Adapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_dashboard_restaurant_home_2_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = FeatureDashboardRestaurantHome2Adapter(itemArrayList)
    ...
    private fun initActions() {
        ...
        mAdapter.setOnItemClickListener(object : FeatureDashboardRestaurantHome2Adapter.OnItemClickListener{
