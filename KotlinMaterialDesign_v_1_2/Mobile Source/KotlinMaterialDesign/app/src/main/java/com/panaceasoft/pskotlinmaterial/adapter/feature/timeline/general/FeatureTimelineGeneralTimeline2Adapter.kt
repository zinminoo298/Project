...
class FeatureTimelineGeneralTimeline2Adapter(private val timelineTodoList: List<TimelineTodo>?, private val limitCount: Int) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
