package com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.detail.detail3
...
import kotlinx.android.synthetic.main.app_ecommerce_detail_3_review_item.view.*
...
class AppECommerceDetail3ReviewAdapter(private val userReviewList: List<UserReview>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_detail_3_review_item, parent, false)
