...
import kotlinx.android.synthetic.main.feature_grid_news_grid_2_item.view.*
import java.util.*
 ...
 */
class FeatureGridNewsGrid2Adapter(private val newsArrayList: ArrayList<News>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: FeatureGridNewsGrid2Adapter.OnItemClickListener
    ...
    fun setOnItemClickListener(mItemClickListener: FeatureGridNewsGrid2Adapter.OnItemClickListener) {
        this.itemClickListener = mItemClickListener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_news_grid_2_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is FeatureGridNewsGrid2Adapter.PlaceViewHolder) {
