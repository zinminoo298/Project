...
import kotlinx.android.synthetic.main.feature_list_general_swipe_to_dismiss_list_item.view.*
...
class FeatureListGeneralSwipeToDismissListAdapter(private val generalListList: MutableList<GeneralList>, private val mDragStartListener: OnStartDragListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>(), ItemTouchHelperAdapter {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_list_general_swipe_to_dismiss_list_item, parent, false)
