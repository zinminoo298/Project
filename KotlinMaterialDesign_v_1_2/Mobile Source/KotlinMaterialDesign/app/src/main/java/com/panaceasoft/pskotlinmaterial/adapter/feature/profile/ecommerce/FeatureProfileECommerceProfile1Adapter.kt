...
import kotlinx.android.synthetic.main.feature_profile_ecommerce_profile_1_item.view.*
import java.util.*
 ...
 */
class FeatureProfileECommerceProfile1Adapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_profile_ecommerce_profile_1_item, parent, false)
