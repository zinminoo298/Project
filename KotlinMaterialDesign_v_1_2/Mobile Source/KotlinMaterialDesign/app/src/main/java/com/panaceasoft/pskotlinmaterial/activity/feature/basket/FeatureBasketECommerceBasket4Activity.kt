...
import com.panaceasoft.pskotlinmaterial.adapter.feature.basket.FeatureBasketECommerceBasket4Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.BasketItemRepository
import kotlinx.android.synthetic.main.feature_basket_ecommerce_basket_4_activity.*

class FeatureBasketECommerceBasket4Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var basketList: List<Basket>
    internal lateinit var adapter: FeatureBasketECommerceBasket4Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_basket_ecommerce_basket_4_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureBasketECommerceBasket4Adapter(basketList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureBasketECommerceBasket4Adapter.OnItemClickListener {
