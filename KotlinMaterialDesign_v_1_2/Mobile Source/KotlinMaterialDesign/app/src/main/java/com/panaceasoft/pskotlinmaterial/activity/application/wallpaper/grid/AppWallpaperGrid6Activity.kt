...
import com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.grid.AppWallpaperGrid6ItemAdapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.app_wallpaper_grid_6_activity.*

class AppWallpaperGrid6Activity : AppCompatActivity() {

    internal lateinit var itemArrayList: List<WallpaperItem>

    internal lateinit var itemAdapter: AppWallpaperGrid6ItemAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.app_wallpaper_grid_6_activity)
    ...
    private fun initUI() {
        ...
        itemAdapter = AppWallpaperGrid6ItemAdapter(itemArrayList)
    ...
    private fun initActions() {
        ...
        itemAdapter.setOnItemClickListener(object : AppWallpaperGrid6ItemAdapter.OnItemClickListener {
