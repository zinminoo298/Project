...
class FeatureListGeneralStickyHeaderListAdapter(private val sectionGalleryListHolderList: List<SectionGalleryListHolder>) : RecyclerView.Adapter<RecyclerView.ViewHolder>(), HeaderItemDecoration.StickyHeaderInterface {
    ...
    override fun getHeaderLayout(headerPosition: Int): Int {
        return R.layout.feature_list_general_sectioned_list_section
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if (viewType == SECTION) {
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_list_general_sticky_header_list_section, parent, false)

            return SectionViewHolder(itemView)
        } else {
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_list_general_sticky_header_list_item, parent, false)
