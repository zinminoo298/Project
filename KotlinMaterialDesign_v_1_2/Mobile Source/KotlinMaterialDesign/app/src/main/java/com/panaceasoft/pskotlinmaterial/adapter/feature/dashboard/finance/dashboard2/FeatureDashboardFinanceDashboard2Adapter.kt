package com.panaceasoft.pskotlinmaterial.adapter.feature.dashboard.finance.dashboard2
...
import kotlinx.android.synthetic.main.feature_dashboard_finance_dashboard_2_item.view.*
...
class FeatureDashboardFinanceDashboard2Adapter(private val financePersonalLogList: List<FinancePersonalLog>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_dashboard_finance_dashboard_2_item, parent, false)
