...
import kotlinx.android.synthetic.main.app_ecommerce_category_4_item.view.*
import java.util.*
 ...
 */
class AppECommerceCategory4Adapter(private val itemArrayList: ArrayList<ShopCategory>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_category_4_item, parent, false)
