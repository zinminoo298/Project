...
import com.panaceasoft.pskotlinmaterial.adapter.application.directory.home.FeatureDashboardDirectoryDashboard10Adapter
import com.panaceasoft.pskotlinmaterial.repository.directory.DirectoryHome7Repository
import com.panaceasoft.pskotlinmaterial.utils.Utils
import java.util.*

class FeatureDashboardDirectoryDashboard10Fragment : Fragment() {

    // data and featuredAdapter
    internal lateinit var itemArrayList: ArrayList<DirectoryHome7Category>
    internal lateinit var itemAdapter: FeatureDashboardDirectoryDashboard10Adapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.feature_dashboard_directory_dashboard_10_fragment, container, false)
    ...
    private fun initUI(view: View) {
        ...
        itemAdapter = FeatureDashboardDirectoryDashboard10Adapter(itemArrayList)


        if (activity != null) {

            // get Item recycler view
            viewall = view.findViewById(R.id.viewAllTextView)
    ...
    private fun initActions() {
        ...
        itemAdapter.setOnItemClickListener(object : FeatureDashboardDirectoryDashboard10Adapter.OnItemClickListener{
