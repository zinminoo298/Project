 ...
 */
class AppWallpaperHome4PagerAdapter(private val context: Context, private val categoryList: List<WallpaperCategory>) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater.inflate(R.layout.app_wallpaper_home_4_view_pager_item, container, false)
