...
import kotlinx.android.synthetic.main.app_news_grid_2_item.view.*
import java.util.*
 ...
 */
class AppNewsGrid2Adapter(private val newsArrayList: ArrayList<News>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: AppNewsGrid2Adapter.OnItemClickListener
    ...
    fun setOnItemClickListener(mItemClickListener: AppNewsGrid2Adapter.OnItemClickListener) {
        this.itemClickListener = mItemClickListener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_news_grid_2_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is AppNewsGrid2Adapter.PlaceViewHolder) {
