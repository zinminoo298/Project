...
import kotlinx.android.synthetic.main.feature_verification_general_verification_1_activity.*

class FeatureVerificationGeneralVerification1Activity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_verification_general_verification_1_activity)
