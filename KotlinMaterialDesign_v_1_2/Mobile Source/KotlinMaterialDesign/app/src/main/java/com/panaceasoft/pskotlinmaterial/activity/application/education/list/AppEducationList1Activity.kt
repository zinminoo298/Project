...
import com.panaceasoft.pskotlinmaterial.adapter.application.education.list.AppEducationList1Adapter
...
class AppEducationList1Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: AppEducationList1Adapter
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppEducationList1Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppEducationList1Adapter.OnItemClickListener {
