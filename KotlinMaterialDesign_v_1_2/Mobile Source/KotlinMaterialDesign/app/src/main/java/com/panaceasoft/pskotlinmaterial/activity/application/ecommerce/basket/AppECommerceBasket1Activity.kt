...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.basket.AppECommerceBasket1Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.BasketItemRepository
import kotlinx.android.synthetic.main.app_ecommerce_basket_1_activity.*

class AppECommerceBasket1Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var basketList: List<Basket>
    internal lateinit var adapter: AppECommerceBasket1Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_basket_1_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppECommerceBasket1Adapter(basketList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppECommerceBasket1Adapter.OnItemClickListener {
