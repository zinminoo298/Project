 ...
 */
class FeatureCoverflowGeneralCoverflow1Adapter(private val context: Context, private val shopItemList: List<ShopItem>) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater.inflate(R.layout.feature_coverflow_general_coverflow_1_item, container, false)
