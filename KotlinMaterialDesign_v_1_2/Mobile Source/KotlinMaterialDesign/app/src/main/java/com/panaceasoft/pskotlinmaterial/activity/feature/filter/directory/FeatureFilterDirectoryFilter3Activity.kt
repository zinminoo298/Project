...
import kotlinx.android.synthetic.main.feature_filter_directory_filter_3_activity.*
import java.util.*

class FeatureFilterDirectoryFilter3Activity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_filter_directory_filter_3_activity)
