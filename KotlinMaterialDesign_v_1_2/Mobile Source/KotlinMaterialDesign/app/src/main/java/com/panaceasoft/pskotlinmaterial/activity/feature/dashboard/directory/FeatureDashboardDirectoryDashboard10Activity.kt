...
import com.panaceasoft.pskotlinmaterial.fragment.feature.dashboard.directory.FeatureDashboardDirectoryDashboard10Fragment
import com.panaceasoft.pskotlinmaterial.utils.Utils
import com.panaceasoft.pskotlinmaterial.utils.common_adapter.ViewPagerAdapter
import kotlinx.android.synthetic.main.feature_dashboard_directory_dashboard_10_activity.*

class FeatureDashboardDirectoryDashboard10Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_dashboard_directory_dashboard_10_activity)
        ...
        try {
            ...
            tab_layout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
                ...
                override fun onTabUnselected(tab: TabLayout.Tab) {
                    if (tab.icon != null) {
                        tab.icon?.setColorFilter(ContextCompat.getColor(this@FeatureDashboardDirectoryDashboard10Activity,R.color.md_grey_200), PorterDuff.Mode.SRC_IN)
                    }
                }
    ...
    private fun setupViewPager(viewPager: ViewPager) {
        ...
        val fragment1 = FeatureDashboardDirectoryDashboard10Fragment()
        fragment1.setType("A")

        val fragment2 = FeatureDashboardDirectoryDashboard10Fragment()
        fragment2.setType("B")

        val fragment3 = FeatureDashboardDirectoryDashboard10Fragment()
        fragment3.setType("C")
