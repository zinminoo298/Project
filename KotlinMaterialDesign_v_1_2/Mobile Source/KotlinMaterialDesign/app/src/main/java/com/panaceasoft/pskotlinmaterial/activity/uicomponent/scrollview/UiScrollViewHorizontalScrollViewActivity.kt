...
import kotlinx.android.synthetic.main.ui_scroll_view_horizontal_scroll_view_activity.*

class UiScrollViewHorizontalScrollViewActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_scroll_view_horizontal_scroll_view_activity)
