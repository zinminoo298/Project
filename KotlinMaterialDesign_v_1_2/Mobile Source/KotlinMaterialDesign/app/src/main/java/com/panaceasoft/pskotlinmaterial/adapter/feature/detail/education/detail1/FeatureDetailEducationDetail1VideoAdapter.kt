package com.panaceasoft.pskotlinmaterial.adapter.feature.detail.education.detail1
...
import kotlinx.android.synthetic.main.feature_detail_education_detail_1_video_item.view.*
...
class FeatureDetailEducationDetail1VideoAdapter(private val educationVideoList: List<EducationVideo>?, private val limitCount: Int) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_detail_education_detail_1_video_item, parent, false)
