...
import com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.home.home2.AppWallpaperHome2CategoryAdapter
import com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.home.home2.AppWallpaperHome2ItemAdapter
...
import kotlinx.android.synthetic.main.app_wallpaper_home_2_activity.*

class AppWallpaperHome2Activity : AppCompatActivity() {

    internal lateinit var itemArrayList: List<WallpaperItem>
    internal lateinit var categoryList: List<WallpaperCategory>
    internal lateinit var wallpaperHome2CategoryAdapter: AppWallpaperHome2CategoryAdapter
    internal lateinit var itemAdapter: AppWallpaperHome2ItemAdapter


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContentView(R.layout.app_wallpaper_home_2_activity)
    ...
    private fun initUI() {
        ...
        wallpaperHome2CategoryAdapter = AppWallpaperHome2CategoryAdapter(categoryList)

        itemAdapter = AppWallpaperHome2ItemAdapter(itemArrayList)
    ...
    private fun initActions() {
        wallpaperHome2CategoryAdapter.setOnItemClickListener(object : AppWallpaperHome2CategoryAdapter.OnItemClickListener {
        ...
        itemAdapter.setOnItemClickListener(object : AppWallpaperHome2ItemAdapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: WallpaperItem, position: Int) {
                Toast.makeText(this@AppWallpaperHome2Activity, "Selected : " + obj.imageName, Toast.LENGTH_SHORT).show()
            }
        })
