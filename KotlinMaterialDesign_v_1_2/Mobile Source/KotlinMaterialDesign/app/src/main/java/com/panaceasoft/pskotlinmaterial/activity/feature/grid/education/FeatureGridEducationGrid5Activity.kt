...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.education.FeatureGridEducationGrid5Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.feature_grid_education_grid_5_activity.*

class FeatureGridEducationGrid5Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: FeatureGridEducationGrid5Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_education_grid_5_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureGridEducationGrid5Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureGridEducationGrid5Adapter.OnItemClickListener {
