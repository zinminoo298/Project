...
import com.panaceasoft.pskotlinmaterial.adapter.application.restaurant.list.AppRestaurantList1Adapter
...
class AppRestaurantListList1Activity : AppCompatActivity() {

    lateinit var itemArrayList: ArrayList<RestaurantFood>
    lateinit var mAdapter: AppRestaurantList1Adapter
    lateinit var recyclerView: RecyclerView


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_restaurant_list_list_1_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = AppRestaurantList1Adapter(itemArrayList)
