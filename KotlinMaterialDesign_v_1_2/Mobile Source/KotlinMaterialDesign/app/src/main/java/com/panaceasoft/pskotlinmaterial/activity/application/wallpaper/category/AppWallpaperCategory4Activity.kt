...
import com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.category.AppWallpaperCategory4ItemAdapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperCategoryRepository
import kotlinx.android.synthetic.main.app_wallpaper_category_4_activity.*
import java.util.*

class AppWallpaperCategory4Activity : AppCompatActivity() {

    private lateinit var itemArrayList: ArrayList<WallpaperCategory>
    private lateinit var mAdapter: AppWallpaperCategory4ItemAdapter
    internal var numberOfColumns = 2

    //region override methods
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_wallpaper_category_4_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = AppWallpaperCategory4ItemAdapter(itemArrayList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : AppWallpaperCategory4ItemAdapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: WallpaperCategory, position: Int) {
                Toast.makeText(this@AppWallpaperCategory4Activity, "Selected : " + obj.name, Toast.LENGTH_LONG).show()
            }
        })
    }
