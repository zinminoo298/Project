...
import kotlinx.android.synthetic.main.app_directory_place_grid_3_item.view.*
import java.util.*
 ...
 */
class AppDirectoryPlaceGrid3Adapter(private val placeArrayList: ArrayList<Place>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_directory_place_grid_3_item, parent, false)
