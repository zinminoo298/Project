...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.detail.detail3.AppECommerceDetail3PagerAdapter
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.detail.detail3.AppECommerceDetail3ReviewAdapter
...
import kotlinx.android.synthetic.main.app_ecommerce_detail_3_activity.*

class AppECommerceDetail3Activity : AppCompatActivity() {
    ...
    // ui variables
    private lateinit var appECommerceDetail3PagerAdapter: AppECommerceDetail3PagerAdapter
    private lateinit var adapter: AppECommerceDetail3ReviewAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_detail_3_activity)
    ...
    private fun initData() {
        ...
        appECommerceDetail3PagerAdapter = AppECommerceDetail3PagerAdapter(this, shopItem)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppECommerceDetail3ReviewAdapter(userReviewList)
    ...
    private fun initActions() {
        ...
        adapter.setOnItemClickListener(object : AppECommerceDetail3ReviewAdapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: UserReview, position: Int) {
                Toast.makeText(this@AppECommerceDetail3Activity, "Selected : " + obj.userName, Toast.LENGTH_LONG).show()
            }
        })

        appECommerceDetail3PagerAdapter.setOnItemClickListener(object : AppECommerceDetail3PagerAdapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: ShopItem, position: Int) {
                Toast.makeText(this@AppECommerceDetail3Activity, "Selected : " + obj.imageList.get(position).imageName!!, Toast.LENGTH_SHORT).show()
            }
        })
