...
import kotlinx.android.synthetic.main.feature_checkout_ecommerce_checkout_3_activity.*

class FeatureCheckoutECommerceCheckout3Activity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_checkout_ecommerce_checkout_3_activity)
