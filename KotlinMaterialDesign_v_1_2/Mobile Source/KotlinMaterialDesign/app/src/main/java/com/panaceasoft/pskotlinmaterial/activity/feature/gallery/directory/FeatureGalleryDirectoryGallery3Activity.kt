...
import com.panaceasoft.pskotlinmaterial.adapter.feature.gallery.directory.FeatureGalleryDirectoryGallery3Adapter
import com.panaceasoft.pskotlinmaterial.repository.directory.SectionGalleryRepository
import kotlinx.android.synthetic.main.feature_gallery_directory_gallery_3_activity.*
import java.util.*

class FeatureGalleryDirectoryGallery3Activity : AppCompatActivity() {

    private lateinit var mAdapter: FeatureGalleryDirectoryGallery3Adapter
    internal var numberOfColumns = 3
    private lateinit var holderList: MutableList<SectionGalleryListHolder>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_gallery_directory_gallery_3_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = FeatureGalleryDirectoryGallery3Adapter(holderList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : FeatureGalleryDirectoryGallery3Adapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: SectionGalleryListHolder, position: Int) {
                Toast.makeText(this@FeatureGalleryDirectoryGallery3Activity, "Selected : " + obj.name, Toast.LENGTH_LONG).show()
            }
        })
    }
