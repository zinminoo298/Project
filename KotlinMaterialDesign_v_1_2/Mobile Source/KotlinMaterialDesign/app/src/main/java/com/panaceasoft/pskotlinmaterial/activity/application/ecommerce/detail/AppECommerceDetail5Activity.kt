...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.detail.detail5.AppECommerceDetail5PagerAdapter
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.detail.detail5.AppECommerceDetail5ReviewAdapter
...
import kotlinx.android.synthetic.main.app_ecommerce_detail_5_activity.*

class AppECommerceDetail5Activity : AppCompatActivity() {
    ...
    // ui variables
    private lateinit var appECommerceDetail5PagerAdapter: AppECommerceDetail5PagerAdapter
    private lateinit var adapter: AppECommerceDetail5ReviewAdapter
    private lateinit var dots: Array<ImageView?>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_detail_5_activity)
    ...
    private fun initData() {
        ...
        appECommerceDetail5PagerAdapter = AppECommerceDetail5PagerAdapter(this, shopItem)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppECommerceDetail5ReviewAdapter(userReviewList)
    ...
    private fun initActions() {
        imageViewPager.addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(position: Int) {
                ...
                for (i in 0 until dotsCount) {
                    dots[i]?.setImageDrawable(ContextCompat.getDrawable(this@AppECommerceDetail5Activity,R.drawable.nonselecteditem_dot))
                }

                dots[position]?.setImageDrawable(ContextCompat.getDrawable(this@AppECommerceDetail5Activity,R.drawable.selecteditem_dot))
            }
        ...
        adapter.setOnItemClickListener(object : AppECommerceDetail5ReviewAdapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: UserReview, position: Int) {
                Toast.makeText(this@AppECommerceDetail5Activity, "Selected : " + obj.userName, Toast.LENGTH_LONG).show()
            }
        })

        appECommerceDetail5PagerAdapter.setOnItemClickListener(object : AppECommerceDetail5PagerAdapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: ShopItem, position: Int) {
                Toast.makeText(this@AppECommerceDetail5Activity, "Selected : " + obj.imageList.get(position).imageName!!, Toast.LENGTH_SHORT).show()
            }
        })
