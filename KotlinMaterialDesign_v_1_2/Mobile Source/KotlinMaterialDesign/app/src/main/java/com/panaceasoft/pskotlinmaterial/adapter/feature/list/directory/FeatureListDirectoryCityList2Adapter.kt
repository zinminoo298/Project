...
import kotlinx.android.synthetic.main.feature_list_directory_city_list_2_item.view.*
import java.util.*
 ...
 */
class FeatureListDirectoryCityList2Adapter(private val countryArrayList: ArrayList<Country>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_list_directory_city_list_2_item, parent, false)
