...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.education.FeatureGridEducationGrid2Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.feature_grid_education_grid_2_activity.*

class FeatureGridEducationGrid2Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: FeatureGridEducationGrid2Adapter


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_education_grid_2_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureGridEducationGrid2Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureGridEducationGrid2Adapter.OnItemClickListener {
