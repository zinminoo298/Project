...
class FeatureDialogGeneralConfirmDialog1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_dialog_general_confirmdialog_1_activity)
    ...
    private fun initUI() {
        initToolbar()
        getCustomLayoutDialog(R.layout.feature_dialog_general_confirmdialog_1_layout)
    }
