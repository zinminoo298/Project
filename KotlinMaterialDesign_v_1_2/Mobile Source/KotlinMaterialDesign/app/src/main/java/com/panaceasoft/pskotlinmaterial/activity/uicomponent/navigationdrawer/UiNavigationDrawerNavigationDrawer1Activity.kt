...
import kotlinx.android.synthetic.main.ui_navigation_drawer_navigation_drawer_1_activity.*

class UiNavigationDrawerNavigationDrawer1Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {

    internal lateinit var toolbar: Toolbar

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_navigation_drawer_navigation_drawer_1_activity)
    ...
    private fun initToolbar() {
        ...
        toolbar.title = "Navigation Drawer 1"
