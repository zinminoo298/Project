...
import kotlinx.android.synthetic.main.app_user_login_2_activity.*

class AppUserLogin2Activity : AppCompatActivity() {

    //region override functions
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_user_login_2_activity)
