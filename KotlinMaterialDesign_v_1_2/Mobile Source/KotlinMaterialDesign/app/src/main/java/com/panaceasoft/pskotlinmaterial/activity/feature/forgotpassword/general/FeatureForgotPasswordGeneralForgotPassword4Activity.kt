...
import kotlinx.android.synthetic.main.feature_forgotpassword_general_forgotpassword_4_activity.*

class FeatureForgotPasswordGeneralForgotPassword4Activity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_forgotpassword_general_forgotpassword_4_activity)
