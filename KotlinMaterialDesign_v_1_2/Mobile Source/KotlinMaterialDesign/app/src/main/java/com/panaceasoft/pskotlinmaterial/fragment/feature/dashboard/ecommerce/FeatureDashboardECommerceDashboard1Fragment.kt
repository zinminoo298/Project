...
import com.panaceasoft.pskotlinmaterial.adapter.feature.dashboard.ecommerce.FeatureDashboardECommerceDashboard1FeaturedItemAdapter
import com.panaceasoft.pskotlinmaterial.adapter.feature.dashboard.ecommerce.FeatureDashboardECommerceDashboard1ItemAdapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import java.util.*

class FeatureDashboardECommerceDashboard1Fragment : Fragment() {

    // data and featuredAdapter
    internal lateinit var itemArrayList: ArrayList<ShopItem>
    internal lateinit var featuredAdapter: FeatureDashboardECommerceDashboard1FeaturedItemAdapter
    internal lateinit var itemAdapter: FeatureDashboardECommerceDashboard1ItemAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.feature_dashboard_ecommerce_dashboard_1_fragment, container, false)
    ...
    private fun initUI(view: View) {
        ...
        featuredAdapter = FeatureDashboardECommerceDashboard1FeaturedItemAdapter(itemArrayList)

        // get item list featuredAdapter
        itemAdapter = FeatureDashboardECommerceDashboard1ItemAdapter(itemArrayList)
    ...
    private fun initActions() {
        featuredAdapter.setOnItemClickListener(object : FeatureDashboardECommerceDashboard1FeaturedItemAdapter.OnItemClickListener {
        ...
        itemAdapter.setOnItemClickListener(object : FeatureDashboardECommerceDashboard1ItemAdapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: ShopItem, position: Int) {
