...
import com.panaceasoft.pskotlinmaterial.adapter.feature.profile.directory.FeatureProfileDirectoryProfile1Adapter
import com.panaceasoft.pskotlinmaterial.repository.directory.UserHistoryRepository
import com.panaceasoft.pskotlinmaterial.utils.Utils
import kotlinx.android.synthetic.main.feature_profile_directory_profile_1_activity.*
import java.util.*

class FeatureProfileDirectoryProfile1Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var historyArrayList: ArrayList<UserHistory>
    internal lateinit var adapter: FeatureProfileDirectoryProfile1Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_profile_directory_profile_1_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureProfileDirectoryProfile1Adapter(historyArrayList)
    ...
    private fun initActions() {
        ...
        adapter.setOnItemClickListener(object : FeatureProfileDirectoryProfile1Adapter.OnItemClickListener {
