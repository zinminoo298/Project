...
import kotlinx.android.synthetic.main.feature_detail_ecommerce_item_detail_5_review_item.view.*
 ...
 */
class FeatureDetailECommerceItemDetail5ReviewAdapter(private val userReviewList: List<UserReview>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_detail_ecommerce_item_detail_5_review_item, parent, false)
