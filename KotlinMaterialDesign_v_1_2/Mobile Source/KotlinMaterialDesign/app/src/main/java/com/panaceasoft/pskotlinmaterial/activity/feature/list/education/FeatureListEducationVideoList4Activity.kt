...
import com.panaceasoft.pskotlinmaterial.adapter.feature.list.education.FeatureListEducationList4Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.feature_list_education_video_list_4_activity.*

class FeatureListEducationVideoList4Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: FeatureListEducationList4Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_list_education_video_list_4_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureListEducationList4Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureListEducationList4Adapter.OnItemClickListener {
