...
import kotlinx.android.synthetic.main.ui_grid_printerest_grid_item.view.*
import java.util.*

class UiGridPinterestGridAdapter(private val itemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: UiGridPinterestGridAdapter.OnItemClickListener

    interface OnItemClickListener {
        fun onItemClick(view: View, obj: ShopItem, position: Int)
    }

    fun setOnItemClickListener(mItemClickListener: UiGridPinterestGridAdapter.OnItemClickListener) {
        this.itemClickListener = mItemClickListener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.ui_grid_printerest_grid_item, parent, false)
    ...
    override fun onBindViewHolder(reholder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (reholder is UiGridPinterestGridAdapter.PlaceViewHolder) {
