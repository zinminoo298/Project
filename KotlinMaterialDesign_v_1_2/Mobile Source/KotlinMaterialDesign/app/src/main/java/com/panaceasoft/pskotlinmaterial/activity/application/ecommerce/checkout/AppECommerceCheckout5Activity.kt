...
import kotlinx.android.synthetic.main.app_ecommerce_checkout_5_activity.*


class AppECommerceCheckout5Activity : AppCompatActivity() {


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_checkout_5_activity)
