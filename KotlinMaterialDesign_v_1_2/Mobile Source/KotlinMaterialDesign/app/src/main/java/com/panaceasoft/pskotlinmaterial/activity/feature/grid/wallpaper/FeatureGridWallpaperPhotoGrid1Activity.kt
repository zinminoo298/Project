...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.wallpaper.FeatureGridWallpaperPhotoGrid1Adapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.feature_grid_wallpaper_photo_grid_1_activity.*

class FeatureGridWallpaperPhotoGrid1Activity : AppCompatActivity() {

    internal lateinit var itemArrayList: List<WallpaperItem>

    internal lateinit var itemAdapter: FeatureGridWallpaperPhotoGrid1Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_wallpaper_photo_grid_1_activity)
    ...
    private fun initUI() {
        ...
        itemAdapter = FeatureGridWallpaperPhotoGrid1Adapter(itemArrayList)
    ...
    private fun initActions() {
        ...
        itemAdapter.setOnItemClickListener(object : FeatureGridWallpaperPhotoGrid1Adapter.OnItemClickListener {
