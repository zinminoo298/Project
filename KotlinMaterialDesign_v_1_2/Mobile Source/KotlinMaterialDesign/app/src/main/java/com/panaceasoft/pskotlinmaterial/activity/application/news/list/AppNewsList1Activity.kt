...
import com.panaceasoft.pskotlinmaterial.adapter.application.news.list.AppNewsList1Adapter
import com.panaceasoft.pskotlinmaterial.repository.news.NewsRepository
import kotlinx.android.synthetic.main.app_news_list_1_activity.*
import java.util.*

class AppNewsList1Activity : AppCompatActivity() {


    // data and adapter
    internal lateinit var newsArrayList: ArrayList<News>
    internal lateinit var adapter: AppNewsList1Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_news_list_1_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppNewsList1Adapter(newsArrayList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppNewsList1Adapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: News, position: Int) {
                Toast.makeText(this@AppNewsList1Activity, "Selected : " + obj.title, Toast.LENGTH_LONG).show()
            }
        })
    }
