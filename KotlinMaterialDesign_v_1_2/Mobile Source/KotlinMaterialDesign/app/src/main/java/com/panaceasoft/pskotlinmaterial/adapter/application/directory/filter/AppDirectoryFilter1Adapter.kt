package com.panaceasoft.pskotlinmaterial.adapter.application.directory.filter
...
import kotlinx.android.synthetic.main.app_directory_filter_1_item.view.*
import java.util.*

/**
 * Created by Panacea-Soft on 7/6/18.
 * Contact Email : teamps.is.cool@gmail.com
 * Website : http://www.panacea-soft.com
 */
class AppDirectoryFilter1Adapter(private val placeArrayList: ArrayList<Place>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_directory_filter_1_item, parent, false)
