...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.wallpaper.FeatureGridWallpaperPhotoGrid4Adapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.feature_grid_wallpaper_photo_grid_4_activity.*

class FeatureGridWallpaperPhotoGrid4Activity : AppCompatActivity() {

    internal lateinit var itemArrayList: List<WallpaperItem>

    internal lateinit var itemAdapter: FeatureGridWallpaperPhotoGrid4Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_wallpaper_photo_grid_4_activity)
    ...
    private fun initUI() {
        ...
        itemAdapter = FeatureGridWallpaperPhotoGrid4Adapter(itemArrayList)
    ...
    private fun initActions() {
        ...
        itemAdapter.setOnItemClickListener(object : FeatureGridWallpaperPhotoGrid4Adapter.OnItemClickListener {
