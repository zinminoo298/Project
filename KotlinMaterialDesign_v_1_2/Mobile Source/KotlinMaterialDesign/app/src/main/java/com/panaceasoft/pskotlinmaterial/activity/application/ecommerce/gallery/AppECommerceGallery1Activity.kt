...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.gallery.AppECommerceGallery1PagerAdapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.app_ecommerce_gallery_1_activity.*

class AppECommerceGallery1Activity : AppCompatActivity() {

    private lateinit var imageViewPager: ViewPager
    private lateinit var pagerAdapter: AppECommerceGallery1PagerAdapter
    private lateinit var shopItemList: List<ShopItem>


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_gallery_1_activity)
    ...
    private fun initData() {
        ...
        pagerAdapter = AppECommerceGallery1PagerAdapter(this, shopItemList)
    }
    ...
    private fun initActions() {
        ...
        pagerAdapter.setOnItemClickListener(object : AppECommerceGallery1PagerAdapter.OnItemClickListener{
