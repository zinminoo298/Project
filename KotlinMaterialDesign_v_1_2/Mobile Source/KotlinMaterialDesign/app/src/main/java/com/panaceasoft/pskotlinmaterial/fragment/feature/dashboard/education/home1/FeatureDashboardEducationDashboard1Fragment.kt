package com.panaceasoft.pskotlinmaterial.fragment.feature.dashboard.education.home1
...
import com.panaceasoft.pskotlinmaterial.adapter.feature.dashboard.education.home1.FeatureDashboardEducationDashboard1CoursesAdapter
import com.panaceasoft.pskotlinmaterial.adapter.feature.dashboard.education.home1.FeatureDashboardEducationDashboard1CoverFlowPagerAdapter
 ...
 */
class FeatureDashboardEducationDashboard1Fragment : Fragment() {
    ...
    private lateinit var featureDashboardEducationDashboard1CoverFlowPagerAdapter: FeatureDashboardEducationDashboard1CoverFlowPagerAdapter
    private lateinit var featureDashboardEducationDashboard1CoursesAdapter1: FeatureDashboardEducationDashboard1CoursesAdapter
    private lateinit var featureDashboardEducationDashboard1CoursesAdapter2: FeatureDashboardEducationDashboard1CoursesAdapter
    private lateinit var featureDashboardEducationDashboard1CoursesAdapter3: FeatureDashboardEducationDashboard1CoursesAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.feature_dashboard_education_dashboard_1_fragment, container, false)
    ...
    private fun initData() {
        ...
        featureDashboardEducationDashboard1CoverFlowPagerAdapter = FeatureDashboardEducationDashboard1CoverFlowPagerAdapter(context, CourseListRepository.courseList)

        featureDashboardEducationDashboard1CoursesAdapter1 = FeatureDashboardEducationDashboard1CoursesAdapter(CourseListRepository.courseList)

        featureDashboardEducationDashboard1CoursesAdapter2 = FeatureDashboardEducationDashboard1CoursesAdapter(CourseListRepository.courseList)

        featureDashboardEducationDashboard1CoursesAdapter3 = FeatureDashboardEducationDashboard1CoursesAdapter(CourseListRepository.courseList)
    }
    ...
    private fun initDataBindings() {
        // bind items
        newCourseRecyclerView.adapter = featureDashboardEducationDashboard1CoursesAdapter1

        imageViewPager.adapter = featureDashboardEducationDashboard1CoverFlowPagerAdapter

        setupSliderPagination()

        topRatedCourseRecyclerView.adapter = featureDashboardEducationDashboard1CoursesAdapter2

        trendingRecyclerView.adapter = featureDashboardEducationDashboard1CoursesAdapter3
    ...
    private fun initActions() {
        ...
        featureDashboardEducationDashboard1CoursesAdapter1.setOnItemClickListener(object : FeatureDashboardEducationDashboard1CoursesAdapter.OnItemClickListener{
        ...
        featureDashboardEducationDashboard1CoursesAdapter2.setOnItemClickListener(object : FeatureDashboardEducationDashboard1CoursesAdapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: Course, position: Int) {
                Toast.makeText(context, "Selected : " + obj.title, Toast.LENGTH_SHORT).show()
            }
        })

        featureDashboardEducationDashboard1CoursesAdapter3.setOnItemClickListener(object :FeatureDashboardEducationDashboard1CoursesAdapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: Course, position: Int) {
                Toast.makeText(context, "Selected : " + obj.title, Toast.LENGTH_SHORT).show()
            }
        })

        featureDashboardEducationDashboard1CoverFlowPagerAdapter.setOnItemClickListener(object : FeatureDashboardEducationDashboard1CoverFlowPagerAdapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: Course, position: Int) {
                Toast.makeText(context, "Selected : " + obj.title, Toast.LENGTH_SHORT).show()
            }
        })
    ...
    fun setupSliderPagination() {
        ...
        dotsCount = featureDashboardEducationDashboard1CoverFlowPagerAdapter.count
