...
import kotlinx.android.synthetic.main.ui_tabs_sticky_tab_layout_activity.*

class UiTabsStickyTabLayoutActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_tabs_sticky_tab_layout_activity)
    ...
    private fun initToolbar() {
        ...
        toolbar.title = "Sticky Tab Layout"
