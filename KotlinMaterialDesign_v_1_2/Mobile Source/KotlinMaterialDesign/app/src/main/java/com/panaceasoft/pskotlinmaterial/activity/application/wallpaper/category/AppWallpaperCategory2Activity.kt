...
import com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.category.AppWallpaperCategory2ItemAdapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperCategoryRepository
import kotlinx.android.synthetic.main.app_wallpaper_category_2_activity.*
import java.util.*

class AppWallpaperCategory2Activity : AppCompatActivity() {

    private lateinit var itemArrayList: ArrayList<WallpaperCategory>
    private lateinit var mAdapter: AppWallpaperCategory2ItemAdapter
    internal var numberOfColumns = 1

    //region override methods
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_wallpaper_category_2_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = AppWallpaperCategory2ItemAdapter(itemArrayList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : AppWallpaperCategory2ItemAdapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: WallpaperCategory, position: Int) {
                Toast.makeText(this@AppWallpaperCategory2Activity, "Selected : " + obj.name, Toast.LENGTH_LONG).show()
            }
        })
    }
