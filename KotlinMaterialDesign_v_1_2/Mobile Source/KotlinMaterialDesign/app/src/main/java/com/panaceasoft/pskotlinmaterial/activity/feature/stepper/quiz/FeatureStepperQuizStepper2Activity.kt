...
import com.panaceasoft.pskotlinmaterial.fragment.feature.stepper.quiz.FeatureStepperQuizStepper2Fragment
import com.panaceasoft.pskotlinmaterial.repository.quiz.QuizGeneralListRepository
import kotlinx.android.synthetic.main.feature_stepper_quiz_stepper_2_activity.*

class FeatureStepperQuizStepper2Activity : AppCompatActivity(), FeatureStepperQuizStepper2Fragment.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_stepper_quiz_stepper_2_activity)
    ...
    private fun initUI() {
        ...
        setupFragment(FeatureStepperQuizStepper2Fragment.newInstance(quizGeneralList[position - 1], position - 1))
