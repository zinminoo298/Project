...
import com.panaceasoft.pskotlinmaterial.adapter.application.news.list.AppNewsList2Adapter
import com.panaceasoft.pskotlinmaterial.repository.news.NewsRepository
import kotlinx.android.synthetic.main.app_news_list_2_activity.*
import java.util.*

class AppNewsList2Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var newsArrayList: ArrayList<News>
    internal lateinit var adapter: AppNewsList2Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_news_list_2_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppNewsList2Adapter(newsArrayList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppNewsList2Adapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: News, position: Int) {
                Toast.makeText(this@AppNewsList2Activity, "Selected : " + obj.title, Toast.LENGTH_LONG).show()
            }
        })
    }
