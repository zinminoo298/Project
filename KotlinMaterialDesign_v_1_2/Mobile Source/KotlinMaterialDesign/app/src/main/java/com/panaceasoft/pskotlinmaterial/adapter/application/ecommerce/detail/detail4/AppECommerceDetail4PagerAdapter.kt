...
class AppECommerceDetail4PagerAdapter(private val context: Context, private val shopItem: ShopItem) : PagerAdapter() {
    ...
    fun setOnItemClickListener(mItemClickListener: AppECommerceDetail4PagerAdapter.OnItemClickListener) {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater.inflate(R.layout.app_ecommerce_detail_4_view_pager_item, container, false)
