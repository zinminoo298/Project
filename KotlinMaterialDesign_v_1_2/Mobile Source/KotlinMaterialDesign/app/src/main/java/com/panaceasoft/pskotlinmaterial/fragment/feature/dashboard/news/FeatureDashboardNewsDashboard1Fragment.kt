package com.panaceasoft.pskotlinmaterial.fragment.feature.dashboard.news
...
import com.panaceasoft.pskotlinmaterial.adapter.feature.dashboard.news.FeatureDashboardNewsDashboard1CategoryAdapter
import com.panaceasoft.pskotlinmaterial.adapter.feature.dashboard.news.FeatureDashboardNewsDashboard1CoverFlowPagerAdapter
import com.panaceasoft.pskotlinmaterial.adapter.feature.dashboard.news.FeatureDashboardNewsDashboard1NewsAdapter
 ...
 */
class FeatureDashboardNewsDashboard1Fragment : Fragment() {

    private lateinit var appNewsHome1CoverFlowPagerAdapter: FeatureDashboardNewsDashboard1CoverFlowPagerAdapter
    private lateinit var imageViewPager: ViewPager
    private lateinit var pager_indicator: LinearLayout
    private lateinit var dots: Array<ImageView?>
    private  var dotsCount: Int = 0

    private lateinit var appNewsHome1CategoryAdapter: FeatureDashboardNewsDashboard1CategoryAdapter
    ...
    internal lateinit var itemAdapter: FeatureDashboardNewsDashboard1NewsAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.feature_dashboard_news_dashboard_1_fragment, container, false)
    ...
    private fun initData() {
        ...
        appNewsHome1CoverFlowPagerAdapter = FeatureDashboardNewsDashboard1CoverFlowPagerAdapter(context, editorPickedNewsList)

        categoryList = NewsCategoryRepository.newsCategoryList

        appNewsHome1CategoryAdapter = FeatureDashboardNewsDashboard1CategoryAdapter(categoryList)
    }
    ...
    private fun initUI(view: View) {
        ...
        itemAdapter = FeatureDashboardNewsDashboard1NewsAdapter(newsList)
    ...
    private fun initActions() {
        ...
        itemAdapter.setOnItemClickListener(object :FeatureDashboardNewsDashboard1NewsAdapter.OnItemClickListener{
        ...
        appNewsHome1CategoryAdapter.setOnItemClickListener(object :FeatureDashboardNewsDashboard1CategoryAdapter.OnItemClickListener{
        ...
        appNewsHome1CoverFlowPagerAdapter.setOnItemClickListener(object : FeatureDashboardNewsDashboard1CoverFlowPagerAdapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: News, position: Int) {
