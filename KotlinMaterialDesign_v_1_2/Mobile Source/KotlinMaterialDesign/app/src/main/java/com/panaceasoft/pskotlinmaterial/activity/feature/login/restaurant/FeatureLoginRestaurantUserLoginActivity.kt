package com.panaceasoft.pskotlinmaterial.activity.feature.login.restaurant
...
class FeatureLoginRestaurantUserLoginActivity : AppCompatActivity() {

    //region override functions
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_login_restaurant_user_login_activity)
