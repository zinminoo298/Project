...
import kotlinx.android.synthetic.main.feature_map_directory_map_2_activity.*
import java.util.*

class FeatureMapDirectoryMap2Activity : AppCompatActivity(), GoogleMap.OnMarkerClickListener, OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_map_directory_map_2_activity)
