...
import kotlinx.android.synthetic.main.app_ecommerce_grid_3_item.view.*
import java.util.*
 ...
 */
class AppECommerceGrid3Adapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_grid_3_item, parent, false)
