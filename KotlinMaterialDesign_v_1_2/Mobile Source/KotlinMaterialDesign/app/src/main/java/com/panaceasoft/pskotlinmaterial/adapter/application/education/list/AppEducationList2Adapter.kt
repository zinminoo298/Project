...
import kotlinx.android.synthetic.main.app_education_list_2_item.view.*
 ...
 */
class AppEducationList2Adapter(private val itemList: List<EducationVideo>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_education_list_2_item, parent, false)
