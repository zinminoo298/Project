...
import com.panaceasoft.pskotlinmaterial.adapter.application.directory.home.AppDirectoryHome8ItemAdapter
import com.panaceasoft.pskotlinmaterial.repository.directory.PlaceRepository
import kotlinx.android.synthetic.main.app_directory_home_8_activity.*
import java.util.*

class AppDirectoryHome8Activity : AppCompatActivity(), GoogleMap.OnMarkerClickListener, OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.app_directory_home_8_activity)
    ...
    private fun initDataBinding(googleMap: GoogleMap) {
        ...
        for (i in placeArrayList.indices) {
            ...
            val customInfoWindow = AppDirectoryHome8ItemAdapter(this)
