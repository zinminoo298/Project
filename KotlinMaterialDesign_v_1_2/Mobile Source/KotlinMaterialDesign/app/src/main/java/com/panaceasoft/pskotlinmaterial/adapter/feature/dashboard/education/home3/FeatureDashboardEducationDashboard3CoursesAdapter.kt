...
import kotlinx.android.synthetic.main.feature_dashboard_education_dashboard_3_course_item.view.*
...
class FeatureDashboardEducationDashboard3CoursesAdapter(private val wallpaperCategoryArrayList: List<Course>?, limitCount: Int) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_dashboard_education_dashboard_3_course_item, parent, false)
    ...
    inner class ItemViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal var bookmarkImageView: ImageView
        ...
        init {
            ...
            bookmarkImageView = view.bookmarkImageView
