...
import com.panaceasoft.pskotlinmaterial.adapter.application.directory.gallery.AppDirectoryGallery2PagerAdapter
import com.panaceasoft.pskotlinmaterial.repository.directory.PlaceRepository
import kotlinx.android.synthetic.main.app_directory_gallery_2_activity.*

class AppDirectoryGallery2Activity : AppCompatActivity() {

    private lateinit var dots: Array<ImageView?>
    private var dotsCount: Int = 0

    internal lateinit var pagerAdapter: AppDirectoryGallery2PagerAdapter
    internal lateinit var placeList: List<Place>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_directory_gallery_2_activity)
    ...
    private fun initData() {
        ...
        pagerAdapter = AppDirectoryGallery2PagerAdapter(this, placeList)
    }
    ...
    private fun initActions() {
        ...
        imageViewPager.addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(position: Int) {
                ...
                for (i in 0 until dotsCount) {
                    dots[i]?.setImageDrawable(ContextCompat.getDrawable(this@AppDirectoryGallery2Activity,R.drawable.nonselecteditem_dot))
                }

                dots[position]?.setImageDrawable(ContextCompat.getDrawable(this@AppDirectoryGallery2Activity,R.drawable.selecteditem_dot))
            }
        ...
        pagerAdapter.setOnItemClickListener(object :AppDirectoryGallery2PagerAdapter.OnItemClickListener{
