...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.list.AppECommerceList2Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.app_ecommerce_list_2_activity.*

class AppECommerceList2Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var shopItemList: List<ShopItem>
    internal lateinit var adapter: AppECommerceList2Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_list_2_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppECommerceList2Adapter(shopItemList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppECommerceList2Adapter.OnItemClickListener {
