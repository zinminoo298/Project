package com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.detail.detail1
...
import kotlinx.android.synthetic.main.app_ecommerce_detail_1_review_item.view.*
...
class AppECommerceDetail1ReviewAdapter(private val userReviewList: List<UserReview>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_detail_1_review_item, parent, false)
