...
import kotlinx.android.synthetic.main.app_ecommerce_list_5_item.view.*
...
class AppECommerceList5Adapter(private val shopItemList: List<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_list_5_item, parent, false)
