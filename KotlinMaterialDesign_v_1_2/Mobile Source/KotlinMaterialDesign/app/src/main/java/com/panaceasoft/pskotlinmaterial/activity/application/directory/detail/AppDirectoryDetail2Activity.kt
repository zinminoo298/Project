...
import com.panaceasoft.pskotlinmaterial.adapter.application.directory.detail.AppDirectoryDetail2ImageListPagerAdapter
import com.panaceasoft.pskotlinmaterial.repository.directory.PlaceRepository
import kotlinx.android.synthetic.main.app_directory_detail_2_activity.*
import java.util.*

class AppDirectoryDetail2Activity : AppCompatActivity(), OnMapReadyCallback {
    ...
    internal lateinit var pagerAdapter: AppDirectoryDetail2ImageListPagerAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.app_directory_detail_2_activity)
    ...
    private fun initData() {
        ...
        pagerAdapter = AppDirectoryDetail2ImageListPagerAdapter(this, imageList)
        ...
        imageViewPager.addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(position: Int) {
                ...
                for (i in 0 until dotsCount) {
                    dots[i]?.setImageDrawable(ContextCompat.getDrawable(this@AppDirectoryDetail2Activity,R.drawable.nonselecteditem_dot))

                }

                dots[position]?.setImageDrawable(ContextCompat.getDrawable(this@AppDirectoryDetail2Activity,R.drawable.selecteditem_dot))
            }
