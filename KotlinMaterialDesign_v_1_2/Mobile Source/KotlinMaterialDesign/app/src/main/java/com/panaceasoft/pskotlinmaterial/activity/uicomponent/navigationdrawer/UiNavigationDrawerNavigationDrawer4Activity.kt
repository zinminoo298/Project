...
import kotlinx.android.synthetic.main.ui_navigation_drawer_navigation_drawer_4_activity.*

class UiNavigationDrawerNavigationDrawer4Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.ui_navigation_drawer_navigation_drawer_4_activity)
    ...
    private fun initToolbar() {
       ...
       if (toolbar.navigationIcon != null) {             toolbar.navigationIcon?.setColorFilter(ContextCompat.getColor(this, R.color.md_white_1000), PorterDuff.Mode.SRC_ATOP)         }
        ...
        toolbar.title = "Navigation Drawer 4"
