...
import com.panaceasoft.pskotlinmaterial.fragment.application.education.detail.detail1.AppEducationDetail1Fragment1
import com.panaceasoft.pskotlinmaterial.fragment.application.education.detail.detail1.AppEducationDetail1Fragment2
...
class AppEducationDetail1Activity : AppCompatActivity() {
    ...
    private fun setupViewPager(viewPager: ViewPager): Int {
        ...
        val fragment1 = AppEducationDetail1Fragment1()

        val fragment2 = AppEducationDetail1Fragment2()
