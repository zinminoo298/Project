...
class AppECommerceDetail3PagerAdapter(private val context: Context, private val shopItem: ShopItem) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater.inflate(R.layout.app_ecommerce_detail_3_view_pager_item, container, false)
