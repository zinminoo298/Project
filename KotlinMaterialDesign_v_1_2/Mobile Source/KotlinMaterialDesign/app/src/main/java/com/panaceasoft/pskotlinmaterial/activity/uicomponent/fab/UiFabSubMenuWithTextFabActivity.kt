...
import kotlinx.android.synthetic.main.ui_fab_submenu_with_fab_activity.*

class UiFabSubMenuWithTextFabActivity : AppCompatActivity() {

    private var twist = false

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_fab_submenu_with_fab_activity)
