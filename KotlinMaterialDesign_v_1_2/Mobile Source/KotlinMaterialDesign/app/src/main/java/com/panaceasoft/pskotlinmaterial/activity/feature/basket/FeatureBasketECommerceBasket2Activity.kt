...
import com.panaceasoft.pskotlinmaterial.adapter.feature.basket.FeatureBasketECommerceBasket2Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.BasketItemRepository
import kotlinx.android.synthetic.main.feature_basket_ecommerce_basket_2_activity.*

class FeatureBasketECommerceBasket2Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var basketList: List<Basket>
    internal lateinit var adapter: FeatureBasketECommerceBasket2Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_basket_ecommerce_basket_2_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureBasketECommerceBasket2Adapter(basketList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureBasketECommerceBasket2Adapter.OnItemClickListener {
