...
import kotlinx.android.synthetic.main.feature_checkout_ecommerce_checkout_2_activity.*

class FeatureCheckoutECommerceCheckout2Activity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_checkout_ecommerce_checkout_2_activity)
