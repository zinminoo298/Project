...
import kotlinx.android.synthetic.main.feature_grid_news_category_grid_2_item.view.*
 ...
 */
class FeatureGridNewsCategoryGrid2Adapter(private val itemArrayList: List<NewsCategory>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_news_category_grid_2_item, parent, false)
