...
import kotlinx.android.synthetic.main.feature_menu_general_menu_6_activity.*

class FeatureMenuGeneralMenu6Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {

    internal lateinit var toolbar: Toolbar

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_menu_general_menu_6_activity)
