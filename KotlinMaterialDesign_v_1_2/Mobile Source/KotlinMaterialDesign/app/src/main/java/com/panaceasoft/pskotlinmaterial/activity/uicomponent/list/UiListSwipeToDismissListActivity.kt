...
import com.panaceasoft.pskotlinmaterial.adapter.uicomponent.list.UiListSwipeToDismissListAdapter
...
import kotlinx.android.synthetic.main.ui_list_swipe_to_dismiss_list_activity.*

class UiListSwipeToDismissListActivity : AppCompatActivity(), OnStartDragListener {

    private lateinit var generalListList: MutableList<GeneralList>
    private lateinit var adapter: UiListSwipeToDismissListAdapter

    private lateinit var mItemTouchHelper: ItemTouchHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_list_swipe_to_dismiss_list_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = UiListSwipeToDismissListAdapter(generalListList, this)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : UiListSwipeToDismissListAdapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: GeneralList, position: Int) {
                Toast.makeText(this@UiListSwipeToDismissListActivity, "Selected : " + obj.name, Toast.LENGTH_SHORT).show()
            }
        })
    }
