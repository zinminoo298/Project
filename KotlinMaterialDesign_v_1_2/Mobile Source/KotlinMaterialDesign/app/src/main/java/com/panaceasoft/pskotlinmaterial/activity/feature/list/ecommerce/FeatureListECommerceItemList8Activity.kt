...
import com.panaceasoft.pskotlinmaterial.adapter.feature.list.ecommerce.FeatureListECommerceItemList8Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.feature_list_ecommerce_item_list_8_activity.*

class FeatureListECommerceItemList8Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var shopItemList: List<ShopItem>
    internal lateinit var adapter: FeatureListECommerceItemList8Adapter


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_list_ecommerce_item_list_8_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureListECommerceItemList8Adapter(shopItemList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureListECommerceItemList8Adapter.OnItemClickListener {
