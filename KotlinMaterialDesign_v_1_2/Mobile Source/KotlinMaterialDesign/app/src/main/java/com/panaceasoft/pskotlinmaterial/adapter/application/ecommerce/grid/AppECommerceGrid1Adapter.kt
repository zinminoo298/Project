...
import kotlinx.android.synthetic.main.app_ecommerce_grid_1_item.view.*
import java.util.*

/**
 * Created by Panacea-Soft on 29/6/18.
 * Contact Email : teamps.is.cool@gmail.com
 * Website : http://www.panacea-soft.com
 */
class AppECommerceGrid1Adapter(private val itemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_grid_1_item, parent, false)
