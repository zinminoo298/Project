...
import com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.list.AppWallpaperList1ItemAdapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.app_wallpaper_list_1_activity.*

class AppWallpaperList1Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var itemList: List<WallpaperItem>
    internal lateinit var adapter: AppWallpaperList1ItemAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_wallpaper_list_1_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppWallpaperList1ItemAdapter(itemList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppWallpaperList1ItemAdapter.OnItemClickListener {
