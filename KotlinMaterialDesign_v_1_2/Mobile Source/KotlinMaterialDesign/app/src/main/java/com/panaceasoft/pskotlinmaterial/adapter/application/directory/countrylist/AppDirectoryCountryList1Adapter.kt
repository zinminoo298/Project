...
import kotlinx.android.synthetic.main.app_directory_country_list_1_item.view.*
import java.util.*

class AppDirectoryCountryList1Adapter(private val countryArrayList: ArrayList<Country>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_directory_country_list_1_item, parent, false)
