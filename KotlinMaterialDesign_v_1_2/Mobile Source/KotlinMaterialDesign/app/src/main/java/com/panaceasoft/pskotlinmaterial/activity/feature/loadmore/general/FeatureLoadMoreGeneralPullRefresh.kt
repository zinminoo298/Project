...
import com.panaceasoft.pskotlinmaterial.adapter.feature.loadmore.FeatureLoadMoreGeneralPullRefreshAdapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.feature_load_more_general_pull_refresh_activity.*
import java.util.*

class FeatureLoadMoreGeneralPullRefresh : AppCompatActivity() {

    // data and wallpaperHome2CategoryAdapter
    internal lateinit var itemArrayList: MutableList<WallpaperItem>
    internal lateinit var itemAdapter: FeatureLoadMoreGeneralPullRefreshAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_load_more_general_pull_refresh_activity)
    ...
    private fun initUI() {
        ...
        itemAdapter = FeatureLoadMoreGeneralPullRefreshAdapter(itemArrayList)
    ...
    private fun initActions() {
        ...
        itemAdapter.setOnItemClickListener(object : FeatureLoadMoreGeneralPullRefreshAdapter.OnItemClickListener {
