...
import kotlinx.android.synthetic.main.app_ecommerce_filter_2_activity.*

class AppECommerceFilter2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.app_ecommerce_filter_2_activity)
