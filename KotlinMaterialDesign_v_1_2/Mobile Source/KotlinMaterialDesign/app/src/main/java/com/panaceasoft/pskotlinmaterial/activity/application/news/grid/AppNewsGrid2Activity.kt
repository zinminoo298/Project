...
import com.panaceasoft.pskotlinmaterial.adapter.application.news.grid.AppNewsGrid2Adapter
import com.panaceasoft.pskotlinmaterial.repository.news.NewsRepository
import kotlinx.android.synthetic.main.app_news_grid_2_activity.*
import java.util.*

class AppNewsGrid2Activity : AppCompatActivity() {

    private lateinit var itemArrayList: ArrayList<News>
    private lateinit var mAdapter: AppNewsGrid2Adapter
    internal var numberOfColumns = 2

    //region override methods
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_news_grid_2_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = AppNewsGrid2Adapter(itemArrayList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : AppNewsGrid2Adapter.OnItemClickListener {
