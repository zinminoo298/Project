package com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.detail.detail2
...
import kotlinx.android.synthetic.main.app_ecommerce_detail_2_review_item.view.*

/**
 * Created by Panacea-Soft on 6/16/18.
 * Contact Email : teamps.is.cool@gmail.com
 */


class AppECommerceDetail2ReviewAdapter(private val userReviewList: List<UserReview>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_detail_2_review_item, parent, false)
