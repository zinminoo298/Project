...
class AppDirectoryHome2PagerAdapter(private val context: Context?, private val placeList: List<Place>) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val layoutInflater = context?.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
            val view = layoutInflater.inflate(R.layout.app_directory_home_2_view_pager_item, container, false)
