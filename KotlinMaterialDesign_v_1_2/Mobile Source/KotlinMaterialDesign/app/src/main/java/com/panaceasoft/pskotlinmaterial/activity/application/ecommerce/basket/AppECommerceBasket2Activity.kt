...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.basket.AppECommerceBasket2Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.BasketItemRepository
import kotlinx.android.synthetic.main.app_ecommerce_basket_2_activity.*

class AppECommerceBasket2Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var basketList: List<Basket>
    internal lateinit var adapter: AppECommerceBasket2Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_basket_2_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppECommerceBasket2Adapter(basketList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppECommerceBasket2Adapter.OnItemClickListener {
