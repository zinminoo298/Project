package com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.home.home3
...
import kotlinx.android.synthetic.main.app_wallpaper_home_3_item.view.*
...
class AppWallpaperHome3ItemAdapter(private val wallpaperItemArrayList: List<WallpaperItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_wallpaper_home_3_item, parent, false)
