...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.home.home3.AppECommerceHome3ItemAdapter
 ...
 */
class AppECommerceHome3Fragment : Fragment() {

    // data
    internal lateinit var itemArrayList: ArrayList<ShopItem>
    internal lateinit var itemAdapter: AppECommerceHome3ItemAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.app_ecommerce_home_3_fragment, container, false)
    ...
    private fun initUI(view: View) {
        ...
        itemAdapter = AppECommerceHome3ItemAdapter(itemArrayList)
    ...
    private fun initActions() {
        itemAdapter.setOnItemClickListener(object : AppECommerceHome3ItemAdapter.OnItemClickListener{
