 ...
 */
class FeatureGalleryECommerceGallery1PagerAdapter(private val context: Context, private val shopItemList: List<ShopItem>) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater.inflate(R.layout.feature_gallery_ecommerce_gallery_1_pager_item, container, false)
