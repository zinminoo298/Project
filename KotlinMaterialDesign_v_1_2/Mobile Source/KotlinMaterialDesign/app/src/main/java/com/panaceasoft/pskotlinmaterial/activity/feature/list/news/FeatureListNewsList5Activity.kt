...
import kotlinx.android.synthetic.main.feature_news_list_list_5_activity.*
import java.util.*

class FeatureListNewsList5Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_news_list_list_5_activity)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppNewsList5Adapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: News, position: Int) {
                Toast.makeText(this@FeatureListNewsList5Activity, "Selected : " + obj.title, Toast.LENGTH_LONG).show()
            }
        })
    }
