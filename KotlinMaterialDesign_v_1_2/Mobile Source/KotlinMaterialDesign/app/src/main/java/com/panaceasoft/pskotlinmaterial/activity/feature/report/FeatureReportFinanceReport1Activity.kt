package com.panaceasoft.pskotlinmaterial.activity.feature.report
...
import com.panaceasoft.pskotlinmaterial.adapter.feature.report.FeatureReportFinanceReport1Adapter
import com.panaceasoft.pskotlinmaterial.repository.finance.TransactionRepository
import kotlinx.android.synthetic.main.feature_report_finance_report_1_activity.*

class FeatureReportFinanceReport1Activity : AppCompatActivity() {

    private lateinit var financePersonalLogList: List<FinancePersonalLog>

    // ui variables
    private lateinit var adapter: FeatureReportFinanceReport1Adapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_report_finance_report_1_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureReportFinanceReport1Adapter(financePersonalLogList)
    ...
    private fun initActions() {
        ...
        adapter.setOnItemClickListener(object : FeatureReportFinanceReport1Adapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: FinancePersonalLog, position: Int) {
                Toast.makeText(this@FeatureReportFinanceReport1Activity, "Selected : " + obj.title, Toast.LENGTH_LONG).show()
            }
        })
