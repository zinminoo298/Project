...
import kotlinx.android.synthetic.main.feature_dashboard_wallpaper_dashboard_4_item.view.*
 ...
 */
class FeatureDashboardWallpaperDashboard4ItemAdapter(private val wallpaperItemArrayList: List<WallpaperItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_dashboard_wallpaper_dashboard_4_item, parent, false)
