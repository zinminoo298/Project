...
import com.panaceasoft.pskotlinmaterial.adapter.feature.profile.directory.FeatureProfileDirectoryProfile3Adapter
import com.panaceasoft.pskotlinmaterial.repository.directory.UserHistoryRepository
import com.panaceasoft.pskotlinmaterial.utils.Utils
import kotlinx.android.synthetic.main.feature_profile_directory_profile_3_activity.*
import java.util.*

class FeatureProfileDirectoryProfile3Activity : AppCompatActivity() {

    private lateinit var historyArrayList: ArrayList<UserHistory>
    private lateinit var adapter: FeatureProfileDirectoryProfile3Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_profile_directory_profile_3_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureProfileDirectoryProfile3Adapter(historyArrayList)
    ...
    private fun initActions() {
        ...
        adapter.setOnItemClickListener(object : FeatureProfileDirectoryProfile3Adapter.OnItemClickListener{
