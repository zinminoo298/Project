package com.panaceasoft.pskotlinmaterial.adapter.feature.detail.education.detail3
...
import kotlinx.android.synthetic.main.feature_detail_education_detail_3_video_item.view.*
...
class FeatureDetailEducationDetail3VideoAdapter(private val educationVideoList: List<EducationVideo>?, private val limitCount: Int) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_detail_education_detail_3_video_item, parent, false)
