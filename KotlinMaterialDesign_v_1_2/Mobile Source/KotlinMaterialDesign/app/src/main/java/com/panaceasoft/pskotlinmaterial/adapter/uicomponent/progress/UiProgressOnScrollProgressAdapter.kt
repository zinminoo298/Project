...
import kotlinx.android.synthetic.main.ui_progress_on_scroll_progress_item.view.*

class UiProgressOnScrollProgressAdapter(private val wallpaperItemArrayList: MutableList<WallpaperItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: UiProgressOnScrollProgressAdapter.OnItemClickListener

    interface OnItemClickListener {
        fun onItemClick(view: View, obj: WallpaperItem, position: Int)
    }

    fun setOnItemClickListener(mItemClickListener: UiProgressOnScrollProgressAdapter.OnItemClickListener) {
        this.itemClickListener = mItemClickListener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.ui_progress_on_scroll_progress_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is UiProgressOnScrollProgressAdapter.ItemViewHolder) {
