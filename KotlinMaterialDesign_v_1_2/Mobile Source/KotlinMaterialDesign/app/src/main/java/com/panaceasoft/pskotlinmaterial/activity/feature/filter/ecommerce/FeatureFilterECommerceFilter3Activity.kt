...
import kotlinx.android.synthetic.main.feature_filter_ecommerce_filter_3_activity.*

class FeatureFilterECommerceFilter3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_filter_ecommerce_filter_3_activity)
