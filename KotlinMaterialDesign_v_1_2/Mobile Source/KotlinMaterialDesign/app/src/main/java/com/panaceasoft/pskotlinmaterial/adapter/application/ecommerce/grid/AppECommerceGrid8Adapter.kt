...
import kotlinx.android.synthetic.main.app_ecommerce_grid_8_item.view.*
import java.util.*
 ...
 */
class AppECommerceGrid8Adapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_grid_8_item, parent, false)
