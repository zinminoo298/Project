...
import kotlinx.android.synthetic.main.feature_list_wallpaper_photo_list_2_item.view.*
 ...
 */
class FeatureListWallpaperPhotoList2Adapter(private val itemList: List<WallpaperItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_list_wallpaper_photo_list_2_item, parent, false)
