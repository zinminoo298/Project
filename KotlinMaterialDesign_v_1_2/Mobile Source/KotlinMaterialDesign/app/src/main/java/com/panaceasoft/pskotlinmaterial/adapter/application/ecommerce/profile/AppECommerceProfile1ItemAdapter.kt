package com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.profile
...
import kotlinx.android.synthetic.main.app_ecommerce_profile_1_item.view.*
import java.util.*
...
class AppECommerceProfile1ItemAdapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_profile_1_item, parent, false)
