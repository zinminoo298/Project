...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.education.FeatureGridEducationGrid3Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.feature_grid_education_grid_3_activity.*

class FeatureGridEducationGrid3Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: FeatureGridEducationGrid3Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_education_grid_3_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureGridEducationGrid3Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureGridEducationGrid3Adapter.OnItemClickListener {
