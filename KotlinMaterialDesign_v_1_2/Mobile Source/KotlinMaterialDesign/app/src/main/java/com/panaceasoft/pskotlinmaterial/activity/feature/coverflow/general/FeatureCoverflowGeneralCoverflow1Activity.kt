...
import com.panaceasoft.pskotlinmaterial.adapter.feature.coverflow.general.FeatureCoverflowGeneralCoverflow1Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.feature_coverflow_general_coverflow_1_activity.*

class FeatureCoverflowGeneralCoverflow1Activity : AppCompatActivity() {

    private lateinit var pagerAdapter: FeatureCoverflowGeneralCoverflow1Adapter
    private lateinit var shopItemList: List<ShopItem>


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_coverflow_general_coverflow_1_activity)
    ...
    private fun initData() {
        ...
        pagerAdapter = FeatureCoverflowGeneralCoverflow1Adapter(this, shopItemList)
    }
    ...
    private fun initActions() {
        ...
        pagerAdapter.setOnItemClickListener(object : FeatureCoverflowGeneralCoverflow1Adapter.OnItemClickListener {
    ...
    private fun initToolbar() {
        ...
        toolbar.title = "Coverflow 1 (Light)"
