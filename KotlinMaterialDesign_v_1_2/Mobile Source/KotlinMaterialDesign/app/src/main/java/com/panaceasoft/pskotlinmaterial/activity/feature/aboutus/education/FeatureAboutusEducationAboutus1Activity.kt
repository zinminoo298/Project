package com.panaceasoft.pskotlinmaterial.activity.feature.aboutus.education
...
import kotlinx.android.synthetic.main.feature_aboutus_education_aboutus_1_activity.*

class FeatureAboutusEducationAboutus1Activity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_aboutus_education_aboutus_1_activity)
