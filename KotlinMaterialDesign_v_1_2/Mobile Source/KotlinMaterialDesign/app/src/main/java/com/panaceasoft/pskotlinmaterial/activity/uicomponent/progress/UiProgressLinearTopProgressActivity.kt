...
import com.panaceasoft.pskotlinmaterial.adapter.uicomponent.progress.UiProgressLinearTopProgressAdapter
import com.panaceasoft.pskotlinmaterial.repository.wallpaper.WallpaperItemRepository
import kotlinx.android.synthetic.main.ui_progress_linear_top_progress_activity.*

class UiProgressLinearTopProgressActivity : AppCompatActivity() {

    // data and wallpaperHome2CategoryAdapter
    internal lateinit var itemArrayList: MutableList<WallpaperItem>

    internal lateinit var itemAdapter: UiProgressLinearTopProgressAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.ui_progress_linear_top_progress_activity)
    ...
    private fun initUI() {
        ...
        itemAdapter = UiProgressLinearTopProgressAdapter(itemArrayList)
    ...
    private fun initActions() {
        ...
        itemAdapter.setOnItemClickListener(object : UiProgressLinearTopProgressAdapter.OnItemClickListener {
    ...
    private fun initToolbar() {
        ...
        toolbar.title = "Linear Top Progress"
    ...
    internal inner class InitializedProgress : AsyncTask<Void, Int, Int>() {
        ...
        override fun onPreExecute() {
            super.onPreExecute()
            progressBarTop.max = 5
        }

        override fun onProgressUpdate(vararg values: Int?) {
            super.onProgressUpdate(*values)
            progressBarTop.progress = values[0]!!
        }
