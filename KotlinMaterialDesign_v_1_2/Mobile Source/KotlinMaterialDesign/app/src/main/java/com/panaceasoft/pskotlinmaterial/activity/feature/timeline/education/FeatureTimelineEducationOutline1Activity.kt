package com.panaceasoft.pskotlinmaterial.activity.feature.timeline.education
...
import com.panaceasoft.pskotlinmaterial.adapter.feature.timeline.education.FeatureTimelineEducationOutline1Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationCourseOutlineRepository
import com.panaceasoft.pskotlinmaterial.utils.Utils
import kotlinx.android.synthetic.main.feature_timeline_education_outline_1_activity.*
import java.util.*

class FeatureTimelineEducationOutline1Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: MutableList<EducationCourseOutlineHolder>
    internal lateinit var adapter: FeatureTimelineEducationOutline1Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_timeline_education_outline_1_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureTimelineEducationOutline1Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureTimelineEducationOutline1Adapter.OnItemClickListener {
