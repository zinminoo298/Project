...
import kotlinx.android.synthetic.main.app_directory_place_map_3_activity.*
import java.util.*

class AppDirectoryPlaceMap3Activity : AppCompatActivity(), GoogleMap.OnMarkerClickListener, OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.app_directory_place_map_3_activity)
