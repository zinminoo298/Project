...
import kotlinx.android.synthetic.main.feature_list_general_scroll_to_top_list_item.view.*

class FeatureListGeneralScrollToTopListAdapter(private val itemList: List<WallpaperItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: FeatureListGeneralScrollToTopListAdapter.OnItemClickListener
    ...
    fun setOnItemClickListener(mItemClickListener: FeatureListGeneralScrollToTopListAdapter.OnItemClickListener) {
        this.itemClickListener = mItemClickListener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_list_general_scroll_to_top_list_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is FeatureListGeneralScrollToTopListAdapter.PlaceViewHolder) {
