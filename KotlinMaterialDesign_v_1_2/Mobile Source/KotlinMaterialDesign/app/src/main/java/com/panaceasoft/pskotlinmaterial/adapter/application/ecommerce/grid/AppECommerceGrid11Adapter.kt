...
import kotlinx.android.synthetic.main.app_ecommerce_grid_11_item.view.*
import java.util.*
 ...
 */
class AppECommerceGrid11Adapter(private val itemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_ecommerce_grid_11_item, parent, false)
