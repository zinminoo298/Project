...
import kotlinx.android.synthetic.main.app_education_grid_1_item.view.*
 ...
 */
class AppEducationGrid1Adapter(private val itemList: List<EducationVideo>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: AppEducationGrid1Adapter.OnItemClickListener
    ...
    fun setOnItemClickListener(mItemClickListener: AppEducationGrid1Adapter.OnItemClickListener) {
        this.itemClickListener = mItemClickListener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_education_grid_1_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is AppEducationGrid1Adapter.PlaceViewHolder) {
