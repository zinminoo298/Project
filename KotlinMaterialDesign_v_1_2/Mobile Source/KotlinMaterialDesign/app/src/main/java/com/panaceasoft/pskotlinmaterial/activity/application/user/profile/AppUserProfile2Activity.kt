...
import kotlinx.android.synthetic.main.app_user_profile_2_activity.*

class AppUserProfile2Activity : AppCompatActivity() {

    //region override functions
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_user_profile_2_activity)
