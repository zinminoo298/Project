...
import kotlinx.android.synthetic.main.feature_grid_ecommerce_item_grid_5_item.view.*
import java.util.*
 ...
 */
class FeatureGridECommerceItemGrid5Adapter(private val shopItemArrayList: ArrayList<ShopItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_grid_ecommerce_item_grid_5_item, parent, false)
    ...
    inner class ItemViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal var itemRatingBar: RatingBar = view.itemRatingBar
