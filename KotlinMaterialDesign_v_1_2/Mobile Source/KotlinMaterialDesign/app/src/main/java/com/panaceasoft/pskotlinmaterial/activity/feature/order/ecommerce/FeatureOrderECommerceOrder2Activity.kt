...
import kotlinx.android.synthetic.main.feature_order_ecommerce_order_2_activity.*

class FeatureOrderECommerceOrder2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_order_ecommerce_order_2_activity)
