...
import com.panaceasoft.pskotlinmaterial.adapter.uicomponent.list.UiListSectionedListAdapter
import com.panaceasoft.pskotlinmaterial.repository.directory.SectionGalleryRepository
import java.util.*

class UiListSectionedListActivity : AppCompatActivity() {

    private lateinit var mAdapter: UiListSectionedListAdapter
    private lateinit var recyclerView: RecyclerView
    private lateinit var holderList: MutableList<SectionGalleryListHolder>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_list_sectioned_list_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = UiListSectionedListAdapter(holderList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : UiListSectionedListAdapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: SectionGalleryListHolder, position: Int) {
                Toast.makeText(this@UiListSectionedListActivity, "Selected : " + obj.name, Toast.LENGTH_LONG).show()
            }
        })
    }
