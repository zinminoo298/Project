...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.news.FeatureGridNewsGrid3Adapter
import com.panaceasoft.pskotlinmaterial.repository.news.NewsRepository
import kotlinx.android.synthetic.main.feature_grid_news_grid_3_activity.*
import java.util.*

class FeatureGridNewsGrid3Activity : AppCompatActivity() {

    private lateinit var itemArrayList: ArrayList<News>
    private lateinit var mAdapter: FeatureGridNewsGrid3Adapter
    internal var numberOfColumns = 2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_news_grid_3_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = FeatureGridNewsGrid3Adapter(itemArrayList)
    ...
    private fun initActions() {
        mAdapter.setOnItemClickListener(object : FeatureGridNewsGrid3Adapter.OnItemClickListener {
