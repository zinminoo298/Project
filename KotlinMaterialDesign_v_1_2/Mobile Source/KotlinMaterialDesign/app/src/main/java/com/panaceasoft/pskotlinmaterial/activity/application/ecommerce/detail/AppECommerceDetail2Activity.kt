...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.detail.detail2.AppECommerceDetail2PagerAdapter
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.detail.detail2.AppECommerceDetail2ReviewAdapter
...
import kotlinx.android.synthetic.main.app_ecommerce_detail_2_activity.*

class AppECommerceDetail2Activity : AppCompatActivity() {
    ...
    // ui variables
    private lateinit var appECommerceDetail2PagerAdapter: AppECommerceDetail2PagerAdapter
    private lateinit var adapter: AppECommerceDetail2ReviewAdapter
    private lateinit var dots: Array<ImageView?>


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_detail_2_activity)
    ...
    private fun initData() {
        ...
        appECommerceDetail2PagerAdapter = AppECommerceDetail2PagerAdapter(this, shopItem)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppECommerceDetail2ReviewAdapter(userReviewList)
    ...
    private fun initDataBindings() {
        ...
        imageViewPager.adapter = appECommerceDetail2PagerAdapter
    ...
    private fun initActions() {
        imageViewPager.addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(position: Int) {
                ...
                for (i in 0 until dotsCount) {
                    dots[i]?.setImageDrawable(ContextCompat.getDrawable(this@AppECommerceDetail2Activity,R.drawable.nonselecteditem_dot))
                }

                dots[position]?.setImageDrawable(ContextCompat.getDrawable(this@AppECommerceDetail2Activity,R.drawable.selecteditem_dot))
            }
        ...
        adapter.setOnItemClickListener(object : AppECommerceDetail2ReviewAdapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: UserReview, position: Int) {
                Toast.makeText(this@AppECommerceDetail2Activity, "Selected : " + obj.userName, Toast.LENGTH_LONG).show()
            }
        })

        appECommerceDetail2PagerAdapter.setOnItemClickListener(object : AppECommerceDetail2PagerAdapter.OnItemClickListener{
            override fun onItemClick(view: View, obj: ShopItem, position: Int) {
                Toast.makeText(this@AppECommerceDetail2Activity, "Selected : " + obj.imageList.get(position).imageName, Toast.LENGTH_SHORT).show()
            }
        })
    ...
    fun setupSliderPagination() {
        ...
        dotsCount = appECommerceDetail2PagerAdapter.count
