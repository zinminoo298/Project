...
import kotlinx.android.synthetic.main.app_wallpaper_home_1_item.view.*
...
class AppWallpaperHome1ItemAdapter(private val wallpaperItemArrayList: List<WallpaperItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_wallpaper_home_1_item, parent, false)
