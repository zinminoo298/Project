...
import com.panaceasoft.pskotlinmaterial.adapter.application.education.grid.AppEducationGrid5Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.app_education_grid_5_activity.*

class AppEducationGrid5Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: AppEducationGrid5Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_education_grid_5_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppEducationGrid5Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppEducationGrid5Adapter.OnItemClickListener {
