package com.panaceasoft.pskotlinmaterial.adapter.feature.profile.directory
...
import kotlinx.android.synthetic.main.feature_profile_directory_profile_1_item.view.*
import java.util.*
 ...
 */
class FeatureProfileDirectoryProfile1Adapter(private val historyArrayList: ArrayList<UserHistory>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_profile_directory_profile_1_item, parent, false)
