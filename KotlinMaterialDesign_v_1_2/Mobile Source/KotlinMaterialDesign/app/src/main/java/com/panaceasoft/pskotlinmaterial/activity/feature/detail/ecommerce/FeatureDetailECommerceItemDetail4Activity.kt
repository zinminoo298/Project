...
import com.panaceasoft.pskotlinmaterial.adapter.feature.detail.ecommerce.FeatureDetailECommerceItemDetail4PagerAdapter
import com.panaceasoft.pskotlinmaterial.adapter.feature.detail.ecommerce.FeatureDetailECommerceItemDetail4ReviewAdapter
...
class FeatureDetailECommerceItemDetail4Activity : AppCompatActivity() {
...
//    internal lateinit var toolbarLayout: CollapsingToolbarLayout
    ...
    private fun initData() {
        ...
        featureECommerceDetail1PagerAdapter = FeatureDetailECommerceItemDetail4PagerAdapter(this, shopItem)
    ...
    private fun initActions() {
        ...
        adapter.setOnItemClickListener(object : FeatureDetailECommerceItemDetail4ReviewAdapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: UserReview, position: Int) {
                Toast.makeText(this@FeatureDetailECommerceItemDetail4Activity, "Selected : " + obj.userName, Toast.LENGTH_LONG).show()
            }
        })

        featureECommerceDetail1PagerAdapter.setOnItemClickListener(object : FeatureDetailECommerceItemDetail4PagerAdapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: ShopItem, position: Int) {
                Toast.makeText(this@FeatureDetailECommerceItemDetail4Activity, "Selected : " + obj.imageList.get(position).imageName, Toast.LENGTH_SHORT).show()
            }
        })
