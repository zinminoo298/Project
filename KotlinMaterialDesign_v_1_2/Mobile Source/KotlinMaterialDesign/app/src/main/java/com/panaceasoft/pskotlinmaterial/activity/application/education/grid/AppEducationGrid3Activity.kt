...
import com.panaceasoft.pskotlinmaterial.adapter.application.education.grid.AppEducationGrid3Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.app_education_grid_3_activity.*

class AppEducationGrid3Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: AppEducationGrid3Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_education_grid_3_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppEducationGrid3Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppEducationGrid3Adapter.OnItemClickListener {
