...
class FeatureProfileECommerceProfile2Adapter(private val context: Context) : GoogleMap.InfoWindowAdapter {
    ...
    override fun getInfoContents(marker: Marker): View {
        val view = (context as Activity).layoutInflater
                .inflate(R.layout.feature_profile_ecommerce_profile_2_item, null)
