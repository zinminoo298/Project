package com.panaceasoft.pskotlinmaterial.adapter.application.wallpaper.category
...
import kotlinx.android.synthetic.main.app_wallpaper_category_4_item.view.*
import java.util.*

/**
 * Created by Panacea-Soft on 3/7/18.
 * Contact Email : teamps.is.cool@gmail.com
 * Website : http://www.panacea-soft.com
 */
class AppWallpaperCategory4ItemAdapter(private val itemArrayList: ArrayList<WallpaperCategory>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_wallpaper_category_4_item, parent, false)
