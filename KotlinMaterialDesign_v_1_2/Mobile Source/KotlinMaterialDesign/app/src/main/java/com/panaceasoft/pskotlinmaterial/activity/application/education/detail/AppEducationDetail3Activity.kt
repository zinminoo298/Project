...
import com.panaceasoft.pskotlinmaterial.adapter.application.education.detail.detail3.AppEducationDetail3VideoAdapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository

class AppEducationDetail3Activity : AppCompatActivity() {
    ...
    private lateinit var appEducationDetail3VideoAdapter: AppEducationDetail3VideoAdapter
    private lateinit var videoRecyclerView: RecyclerView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_education_detail_3_activity)
    ...
    private fun initData() {
        appEducationDetail3VideoAdapter = AppEducationDetail3VideoAdapter(EducationVideoListRepository.educationVideoList, 10)
    }
    ...
    private fun initDataBindings() {
        videoRecyclerView.adapter = appEducationDetail3VideoAdapter
    }

    private fun initActions() {
        appEducationDetail3VideoAdapter.setOnItemClickListener(object : AppEducationDetail3VideoAdapter.OnItemClickListener {
            override fun onItemClick(view: View, obj: EducationVideo, position: Int) {
                Toast.makeText(this@AppEducationDetail3Activity, "Selected : " + obj.title, Toast.LENGTH_SHORT).show()
            }
        })
    }
