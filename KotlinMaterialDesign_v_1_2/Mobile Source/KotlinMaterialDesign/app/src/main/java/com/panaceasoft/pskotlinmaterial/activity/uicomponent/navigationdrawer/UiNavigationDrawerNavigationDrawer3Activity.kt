...
import kotlinx.android.synthetic.main.ui_navigation_drawer_navigation_drawer_3_activity.*

class UiNavigationDrawerNavigationDrawer3Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {

    internal lateinit var toolbar: Toolbar

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.ui_navigation_drawer_navigation_drawer_3_activity)
    ...
    private fun initToolbar() {
        ...
        toolbar.title = "Navigation Drawer 3"
