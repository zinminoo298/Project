package com.panaceasoft.pskotlinmaterial.adapter.feature.loadmore
...
import kotlinx.android.synthetic.main.feature_load_more_general_pull_refresh_item.view.*
...
class FeatureLoadMoreGeneralPullRefreshAdapter(private val wallpaperItemArrayList: MutableList<WallpaperItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_load_more_general_pull_refresh_item, parent, false)
