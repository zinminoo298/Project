...
import com.panaceasoft.pskotlinmaterial.adapter.feature.grid.education.FeatureGridEducationGrid1Adapter
import com.panaceasoft.pskotlinmaterial.repository.education.EducationVideoListRepository
import kotlinx.android.synthetic.main.feature_grid_education_grid_1_activity.*

class FeatureGridEducationGrid1Activity : AppCompatActivity() {


    // data and adapter
    internal lateinit var videoList: List<EducationVideo>
    internal lateinit var adapter: FeatureGridEducationGrid1Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_grid_education_grid_1_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureGridEducationGrid1Adapter(videoList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureGridEducationGrid1Adapter.OnItemClickListener {
