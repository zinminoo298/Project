 ...
 */
class FeatureDashboardNewsDashboard1CoverFlowPagerAdapter(private val context: Context?, private val newsList: List<News>) : PagerAdapter() {
    private lateinit var itemClickListener: FeatureDashboardNewsDashboard1CoverFlowPagerAdapter.OnItemClickListener

    interface OnItemClickListener {
        fun onItemClick(view: View, obj: News, position: Int)
    }

    fun setOnItemClickListener(mItemClickListener: FeatureDashboardNewsDashboard1CoverFlowPagerAdapter.OnItemClickListener) {
