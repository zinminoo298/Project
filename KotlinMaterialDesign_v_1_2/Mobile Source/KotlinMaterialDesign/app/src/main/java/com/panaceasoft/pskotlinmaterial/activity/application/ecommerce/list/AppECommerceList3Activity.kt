...
import com.panaceasoft.pskotlinmaterial.adapter.application.ecommerce.list.AppECommerceList3Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.app_ecommerce_list_3_activity.*

class AppECommerceList3Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var shopItemList: List<ShopItem>
    internal lateinit var adapter: AppECommerceList3Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_ecommerce_list_3_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = AppECommerceList3Adapter(shopItemList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : AppECommerceList3Adapter.OnItemClickListener {
