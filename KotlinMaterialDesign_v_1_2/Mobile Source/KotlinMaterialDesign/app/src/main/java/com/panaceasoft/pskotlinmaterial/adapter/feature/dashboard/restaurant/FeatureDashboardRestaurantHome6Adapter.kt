...
import kotlinx.android.synthetic.main.app_restaurant_home_6_item.view.*
import java.util.*

class FeatureDashboardRestaurantHome6Adapter(private val itemArrayList: ArrayList<RestaurantFood>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_dashboard_restaurant_home_6_item, parent, false)
