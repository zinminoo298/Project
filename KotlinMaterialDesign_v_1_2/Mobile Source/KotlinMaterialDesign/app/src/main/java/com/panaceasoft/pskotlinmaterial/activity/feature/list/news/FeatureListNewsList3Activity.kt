...
import com.panaceasoft.pskotlinmaterial.adapter.feature.list.news.FeatureListNewsList3Adapter
import com.panaceasoft.pskotlinmaterial.repository.news.NewsRepository
import kotlinx.android.synthetic.main.feature_list_news_list_3_activity.*
import java.util.*

class FeatureListNewsList3Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var newsArrayList: ArrayList<News>
    internal lateinit var adapter: FeatureListNewsList3Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_list_news_list_3_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureListNewsList3Adapter(newsArrayList)
    ...
    private fun initActions() {
        ...
        adapter.setOnItemClickListener(object : FeatureListNewsList3Adapter.OnItemClickListener {
