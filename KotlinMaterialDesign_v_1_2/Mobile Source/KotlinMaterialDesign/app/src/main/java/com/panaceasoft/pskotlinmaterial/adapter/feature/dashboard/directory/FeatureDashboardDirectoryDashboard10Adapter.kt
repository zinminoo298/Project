...
import kotlinx.android.synthetic.main.feature_dashboard_directory_dashboard_10_item.view.*
 ...
 */
class FeatureDashboardDirectoryDashboard10Adapter(private val catArrayList: ArrayList<DirectoryHome7Category>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_dashboard_directory_dashboard_10_item, parent, false)
