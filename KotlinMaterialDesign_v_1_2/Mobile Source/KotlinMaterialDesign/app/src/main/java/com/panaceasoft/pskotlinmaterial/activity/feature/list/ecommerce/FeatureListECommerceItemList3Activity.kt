...
import com.panaceasoft.pskotlinmaterial.adapter.feature.list.ecommerce.FeatureListECommerceItemList3Adapter
import com.panaceasoft.pskotlinmaterial.repository.ecommerce.ShopItemRepository
import kotlinx.android.synthetic.main.feature_list_ecommerce_item_list_3_activity.*

class FeatureListECommerceItemList3Activity : AppCompatActivity() {

    // data and adapter
    internal lateinit var shopItemList: List<ShopItem>
    internal lateinit var adapter: FeatureListECommerceItemList3Adapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.feature_list_ecommerce_item_list_3_activity)
    ...
    private fun initUI() {
        ...
        // get list adapter
        adapter = FeatureListECommerceItemList3Adapter(shopItemList)
    ...
    private fun initActions() {
        adapter.setOnItemClickListener(object : FeatureListECommerceItemList3Adapter.OnItemClickListener {
