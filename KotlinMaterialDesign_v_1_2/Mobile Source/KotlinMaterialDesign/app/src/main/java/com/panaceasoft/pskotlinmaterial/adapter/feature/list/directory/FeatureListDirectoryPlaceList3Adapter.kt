...
import kotlinx.android.synthetic.main.feature_list_directory_place_list_3_item.view.*
import java.util.*
 ...
 */
class FeatureListDirectoryPlaceList3Adapter(private val placeArrayList: ArrayList<Place>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.feature_list_directory_place_list_3_item, parent, false)
