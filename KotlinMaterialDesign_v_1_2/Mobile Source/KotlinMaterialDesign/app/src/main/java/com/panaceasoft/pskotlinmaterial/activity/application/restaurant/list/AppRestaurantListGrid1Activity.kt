package com.panaceasoft.pskotlinmaterial.activity.application.restaurant.list
...
import com.panaceasoft.pskotlinmaterial.adapter.application.restaurant.list.AppRestaurantGrid1Adapter
...
class AppRestaurantListGrid1Activity : AppCompatActivity() {

    lateinit var itemArrayList: ArrayList<RestaurantFood>
    lateinit var mAdapter: AppRestaurantGrid1Adapter
    lateinit var recyclerView: RecyclerView
    internal var numberOfColumns = 2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_restaurant_list_grid_1_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = AppRestaurantGrid1Adapter(itemArrayList)
    ...
    private fun initActions() {
      mAdapter.setOnItemClickListener(object : AppRestaurantGrid1Adapter.OnItemClickListener {
