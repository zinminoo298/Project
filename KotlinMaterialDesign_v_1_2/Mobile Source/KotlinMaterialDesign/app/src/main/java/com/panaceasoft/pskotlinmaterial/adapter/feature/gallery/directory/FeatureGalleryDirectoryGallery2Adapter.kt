...
class FeatureGalleryDirectoryGallery2Adapter(private val context: Context, private val placeItemArrayList: List<Place>) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater.inflate(R.layout.feature_gallery_directory_gallery_2_pager_item, container, false)
