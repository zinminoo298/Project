package com.panaceasoft.pskotlinmaterial.adapter.application.education.list
...
import kotlinx.android.synthetic.main.app_education_list_3_item.view.*
 ...
 */
class AppEducationList3Adapter(private val itemList: List<EducationVideo>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private lateinit var itemClickListener: AppEducationList3Adapter.OnItemClickListener
    ...
    fun setOnItemClickListener(mItemClickListener: AppEducationList3Adapter.OnItemClickListener) {
        this.itemClickListener = mItemClickListener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_education_list_3_item, parent, false)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (viewHolder is AppEducationList3Adapter.PlaceViewHolder) {
