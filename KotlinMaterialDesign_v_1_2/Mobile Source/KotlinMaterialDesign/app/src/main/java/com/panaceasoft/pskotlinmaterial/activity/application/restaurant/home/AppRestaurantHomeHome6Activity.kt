...
import com.panaceasoft.pskotlinmaterial.adapter.application.restaurant.home.AppRestaurantHome6Adapter
...
class AppRestaurantHomeHome6Activity : AppCompatActivity() {

    lateinit var itemArrayList: ArrayList<RestaurantFood>
    lateinit var mAdapter: AppRestaurantHome6Adapter
    lateinit var recyclerView: RecyclerView
    internal var numberOfColumns = 2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.app_restaurant_home_6_activity)
    ...
    private fun initUI() {
        ...
        mAdapter = AppRestaurantHome6Adapter(itemArrayList)
...
//        mAdapter!!.setOnItemClickListener({ view, obj, position -> Toast.makeText(this, "Selected : " + obj.name, Toast.LENGTH_LONG).show() })
    mAdapter.setOnItemClickListener(object : AppRestaurantHome6Adapter.OnItemClickListener{
