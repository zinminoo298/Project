...
class FeatureDialogGeneralWarningDialog1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_dialog_general_warningdialog_1_activity)
    ...
    private fun initUI() {
        initToolbar()
        getCustomLayoutDialog(R.layout.feature_dialog_general_warningdialog_1_layout)
    }
