...
class AppDirectoryGallery4Adapter(private val sectionGalleryListHolderList: List<SectionGalleryListHolder>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if (viewType == SECTION) {
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_directory_gallery_4_section, parent, false)

            return SectionViewHolder(itemView)
        } else if (viewType == ITEM) {
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_directory_gallery_4_item, parent, false)

            return PlaceViewHolder(itemView)
        } else {
            val itemView = LayoutInflater.from(parent.context).inflate(R.layout.app_directory_gallery_4_last_item, parent, false)
