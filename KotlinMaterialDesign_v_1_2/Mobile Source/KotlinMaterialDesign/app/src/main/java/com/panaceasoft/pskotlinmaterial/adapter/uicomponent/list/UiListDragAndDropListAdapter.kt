...
class UiListDragAndDropListAdapter(private val generalListList: List<GeneralList>, private val mDragStartListener: OnStartDragListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>(), ItemTouchDragHelperAdapter {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.ui_list_drag_and_drop_list_item, parent, false)
    ...
    inner class GeneralListViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        internal var captionTextView: TextView = view.findViewById(R.id.captionTextView)
        internal var dragImageView: ImageView = view.findViewById(R.id.dragImageView)
        internal var rowImageView: ImageView = view.findViewById(R.id.rowImageView)
