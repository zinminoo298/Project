...
import kotlinx.android.synthetic.main.app_ecommerce_filter_4_activity.*
import java.util.*

class AppECommerceFilter4Activity : AppCompatActivity() {

    private lateinit var floatingActionButton: FloatingActionButton

    internal lateinit var sizeSpinner: Spinner
    internal lateinit var brandSpinner: Spinner
    ...
    internal lateinit var priceRangeToValueTextView: TextView
    internal lateinit var priceRangeFromValueTextView: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.app_ecommerce_filter_4_activity)
    ...
    private fun initUI() {
        ...
        floatingActionButton = findViewById(R.id.filterFab)
    ...
    private fun initActions() {
        floatingActionButton.setOnClickListener { getCustomLayoutDialog(R.layout.app_ecommerce_filter_4_dialog) }
    }
    ...
    private fun getCustomLayoutDialog(layoutId: Int) {
        ...
        if (dialog.window != null) {
            ...
            // Size Spinner
            sizeSpinner = dialog.findViewById(R.id.sizeSpinner)
            ...
            // Brand Spinner
            brandSpinner = dialog.findViewById(R.id.brandSpinner)
            ...
            // price range
            priceRangeToValueTextView = dialog.findViewById(R.id.priceRangeToValueTextView)
            priceRangeFromValueTextView = dialog.findViewById(R.id.priceRangeFromValueTextView)
