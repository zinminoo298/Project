 ...
 */
class FeatureStepperQuizStepper1Fragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.feature_stepper_quiz_stepper_1_fragment, container, false)
    ...
    companion object {
        ...
        fun newInstance(quizGeneral: QuizGeneral, position: Int): FeatureStepperQuizStepper1Fragment {
            val fragment = FeatureStepperQuizStepper1Fragment()
