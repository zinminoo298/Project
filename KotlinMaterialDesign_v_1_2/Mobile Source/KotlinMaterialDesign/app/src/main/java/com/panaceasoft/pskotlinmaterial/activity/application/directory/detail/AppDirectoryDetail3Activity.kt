...
import kotlinx.android.synthetic.main.app_directory_detail_3_activity.*

class AppDirectoryDetail3Activity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.app_directory_detail_3_activity)
