...
import kotlinx.android.synthetic.main.feature_detail_education_detail_2_activity.*

class FeatureDetailEducationDetail2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.feature_detail_education_detail_2_activity)
